...
import { XhrIo as _, EventType as N, ErrorCode as D, createWebChannelTransport as A, getStatEventTarget as C, FetchXmlHttpFactory as k, WebChannel as x, Event as M, Stat as R } from "@firebase/webchannel-wrapper";

var V = "@firebase/firestore", L = /** @class */ function() {
    function t(t) {
        this.uid = t;
    }
 ...
 */ var H = {
    ...
    return t.prototype.start = function(t, e) {
        ...
        this.o = function() {
            i.i++, i.currentUser = i.u(), a.resolve(), a = new X, t.enqueueRetryable((function() {
        ...
        setTimeout((function() {
            if (!i.auth) {
                ...
                q("FirebaseAuthCredentialsProvider", "Auth not yet detected"), a.resolve(), a = new X);
            }
        }), 0), u();
    ...
    return t.prototype.start = function(t, e) {
        var n = this, r = function(t) {
            null != t.error && q("FirebaseAppCheckTokenProvider", "Error getting App Check token; using placeholder token instead. Error: " + t.error.message);
            var r = t.token !== n.p;
            return n.p = t.token, q("FirebaseAppCheckTokenProvider", "Received " + (r ? "new" : "existing") + " token."), 
...
function Ut(t) {
    return "nullValue" in t ? 0 /* NullValue */ : "booleanValue" in t ? 1 /* BooleanValue */ : "integerValue" in t || "doubleValue" in t ? 2 /* NumberValue */ : "timestampValue" in t ? 3 /* TimestampValue */ : "stringValue" in t ? 5 /* StringValue */ : "bytesValue" in t ? 6 /* BlobValue */ : "referenceValue" in t ? 7 /* RefValue */ : "geoPointValue" in t ? 8 /* GeoPointValue */ : "arrayValue" in t ? 9 /* ArrayValue */ : "mapValue" in t ? At(t) ? 4 /* ServerTimestampValue */ : Zt(t) ? 9 /* ArrayValue */ : 10 /* ObjectValue */ : G();
}
...
/** Returns all directional (ascending/descending) segments for this index. */ function ae(t) {
...
e) {
    ...
    return t.min = function() {
        return new t(dt.min(), Ot.empty(), -1);
    }, t;
 ...
 * property.
 */
function fe(t, e, n, r, i, o, s) {
    return void 0 === e && (e = null), void 0 === n && (n = []), void 0 === r && (r = []), 
    void 0 === i && (i = null), void 0 === o && (o = null), void 0 === s && (s = null), 
    new le(t, e, n, r, i, o, s);
}
...
function de(t) {
    ...
    if (null === e.P) {
        ...
        null !== e.collectionGroup && (n += "|cg:" + e.collectionGroup), n += "|f:", n += e.filters.map((function(t) {
            return (e = t).field.canonicalString() + e.op.toString() + Gt(e.value);
            var e;
...
/** Returns the field filters that target the given field path. */ function ye(t, e) {
    return t.filters.filter((function(t) {
        return t instanceof me && t.field.isEqual(e);
    }));
}
 ...
 */ var me = /** @class */ function(e) {
     ...
     */    return t(n, e), n.create = function(t, e, r) {
        return t.isKeyField() ? "in" /* IN */ === e || "not-in" /* NOT_IN */ === e ? this.V(t, e, r) : new ge(t, e, r) : "array-contains" /* ARRAY_CONTAINS */ === e ? new Ee(t, r) : "in" /* IN */ === e ? new Te(t, r) : "not-in" /* NOT_IN */ === e ? new Se(t, r) : "array-contains-any" /* ARRAY_CONTAINS_ANY */ === e ? new _e(t, r) : new n(t, e, r);
    }, n.V = function(t, e, n) {
        return "in" /* IN */ === e ? new we(t, n) : new be(t, n);
    }, n.prototype.matches = function(t) {
        var e = t.data.field(this.field);
        // Types do not have to match in NOT_EQUAL filters.
                return "!=" /* NOT_EQUAL */ === this.op ? null !== e && this.v(Kt(e, this.value)) : null !== e && Ut(this.value) === Ut(e) && this.v(Kt(e, this.value));
...
function Ce(t, e, n) {
    for (var r = 0, i = 0; i < t.position.length; i++) {
        ...
        if (r = o.field.isKeyField() ? Ot.comparator(Ot.fromName(s.referenceValue), n.key) : Kt(s, n.data.field(o.field)), 
...
/** Creates a new Query instance with the options provided. */ function Me(t, e, n, r, i, o, s, a) {
    return new xe(t, e, n, r, i, o, s, a);
}
 ...
 */ function qe(t) {
    var e = W(t);
    if (!e.C) if ("F" /* First */ === e.limitType) e.C = fe(e.path, e.collectionGroup, Ue(e), e.filters, e.limit, e.startAt, e.endAt); else {
        for (
        ...
        // We need to swap the cursors to match the now-flipped query ordering.
                var a = e.endAt ? new Ne(e.endAt.position, !e.endAt.inclusive) : null, u = e.startAt ? new Ne(e.startAt.position, !e.startAt.inclusive) : null;
        // Now return as a LimitType.First query.
                e.C = fe(e.path, e.collectionGroup, n, e.filters, e.limit, a, u);
    }
    return e.C;
}
...
function Ke(t, e) {
    return pe(qe(t), qe(e)) && t.limitType === e.limitType;
}
...
/** Returns whether `doc` matches the constraints of `query`. */ function ze(t, e) {
 ...
 */
        ...
        }(t.startAt, Ue(t), e)) && !(t.endAt && !function(t, e, n) {
            var r = Ce(t, e, n);
            return t.inclusive ? r >= 0 : r > 0;
        }(t.endAt, Ue(t), e));
    }(t, e);
 ...
 * limitations under the License.
 */
/** Used to represent a field transform on a mutation. */ var Je = function() {
 ...
 */ function $e(t, e, n) {
    ...
    }(n, e) : t instanceof nn ? rn(t, e) : t instanceof on ? sn(t, e) : function(t, e) {
        // PORTING NOTE: Since JavaScript's integer arithmetic is limited to 53 bit
        // precision and resolves overflows by reducing precision, we do not
        // manually cap overflows at 2^63.
        var n = tn(t, e), r = un(n) + un(t.k);
        return Wt(n) && Wt(t.k) ? Ye(r) : He(t.M, r);
    }(t, e);
}
 ...
 */ function Ze(t, e, n) {
    ...
    // applications.
    return t instanceof nn ? rn(t, e) : t instanceof on ? sn(t, e) : n;
}
 ...
 */ function tn(t, e) {
    return t instanceof an ? Wt(n = e) || function(t) {
...
/** Transforms a value into a server-generated timestamp. */ var en = /** @class */ function(e) {
    function n() {
        return null !== e && e.apply(this, arguments) || this;
    }
    return t(n, e), n;
}(Je), nn = /** @class */ function(e) {
    function n(t) {
        var n = this;
...
/** Transforms an array value via a union operation. */ function rn(t, e) {
    for (var n = cn(e), r = function(t) {
        n.some((function(e) {
            return qt(e, t);
        })) || n.push(t);
...
/** Transforms an array value via a remove operation. */ var on = /** @class */ function(e) {
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).elements = t, n;
    }
 ...
 * limitations under the License.
 */
/** A field path and the TransformOperation to perform upon it. */ var hn = function(t, e) {
 ...
 */
/** Returns true if the preconditions is valid for the given document. */ function dn(t, e) {
 ...
 */ function vn(t, e, n) {
    t instanceof bn ? function(t, e, n) {
        ...
        // must have held.
        var r = t.value.clone(), i = Tn(t.fieldTransforms, e, n.transformResults);
        r.setAll(i), e.convertToFoundDocument(n.version, r).setHasCommittedMutations();
    }(t, e, n) : t instanceof In ? function(t, e, n) {
        if (dn(t.precondition, e)) {
            var r = Tn(t.fieldTransforms, e, n.transformResults), i = e.data;
            i.setAll(En(t)), i.setAll(r), e.convertToFoundDocument(n.version, i).setHasCommittedMutations();
 ...
 */ function yn(t, e, n) {
    t instanceof bn ? function(t, e, n) {
        if (dn(t.precondition, e)) {
            ...
            r.setAll(i), e.convertToFoundDocument(wn(e), r).setHasLocalMutations();
        }
    }(t, e, n) : t instanceof In ? function(t, e, n) {
        if (dn(t.precondition, e)) {
            var r = Sn(t.fieldTransforms, n, e), i = e.data;
            i.setAll(En(t)), i.setAll(r), e.convertToFoundDocument(wn(e), i).setHasLocalMutations();
        }
    }(t, e, n) : function(t, e) {
        dn(t.precondition, e) && 
 ...
 */ function mn(t, e) {
    for (var n = null, r = 0, i = t.fieldTransforms; r < i.length; r++) {
        var o = i[r], s = e.data.field(o.field), a = tn(o.transform, s || null);
        null != a && (null == n && (n = ne.empty()), n.set(o.field, a));
    }
    return n || null;
}
        ...
        return void 0 === t && void 0 === e || !(!t || !e) && ht(t, e, (function(t, e) {
            return function(t, e) {
                return t.field.isEqual(e.field) && function(t, e) {
                    return t instanceof nn && e instanceof nn || t instanceof on && e instanceof on ? ht(t.elements, e.elements, qt) : t instanceof an && e instanceof an ? qt(t.k, e.k) : t instanceof en && e instanceof en;
 ...
 */ function Sn(t, e, n) {
    for (var r = new Map, i = 0, o = t; i < o.length; i++) {
        ...
        r.set(s.field, $e(a, u, e));
    }
    return r;
}

/** A mutation that deletes the document at the given key. */ var _n, Nn, Dn = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
 ...
 *     Code.UNKNOWN.
 */ (Nn = _n || (_n = {}))[Nn.OK = 0] = "OK", Nn[Nn.CANCELLED = 1] = "CANCELLED", 
...
var Mn = /** @class */ function() {
    ...
    function t(t, e) {
        this.comparator = t, this.root = e || Ln.EMPTY;
    }
    // Returns a copy of the map, with the specified key/value added or replaced.
        return t.prototype.insert = function(e, n) {
        return new t(this.comparator, this.root.insert(e, n, this.comparator).copy(null, null, Ln.BLACK, null, null));
    }, 
    // Returns a copy of the map, with the specified key removed.
    t.prototype.remove = function(e) {
        return new t(this.comparator, this.root.remove(e, this.comparator).copy(null, null, Ln.BLACK, null, null));
    }, 
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
Ln.EMPTY = null, Ln.RED = !0, Ln.BLACK = !1, 
// end LLRBEmptyNode
Ln.EMPTY = new (/** @class */ function() {
    function t() {
        this.size = 0;
    }
...
var On = /** @class */ function() {
    ...
    /** Finds the least element greater than or equal to `elem`. */ t.prototype.firstAfterOrEqual = function(t) {
        ...
        return new Fn(this.data.getIterator());
    }, t.prototype.getIteratorFrom = function(t) {
        return new Fn(this.data.getIteratorFrom(t));
    }, 
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */ var Un = new Rn(Ot.comparator);

function qn() {
    return Un;
}

var Bn = new Rn(Ot.comparator);
...
var Gn = new Rn(Ot.comparator), zn = new On(Ot.comparator);
 ...
 */ var Yn = /** @class */ function() {
    ...
    // PORTING NOTE: Multi-tab only
        ...
        var r = new Map;
        return r.set(e, Xn.createSynthesizedTargetChangeForCurrentChange(e, n)), new t(dt.min(), r, Hn(), qn(), Qn());
    }, t;
}(), Xn = /** @class */ function() {
    function t(
    /**
    ...
    return t.createSynthesizedTargetChangeForCurrentChange = function(e, n) {
        return new t(Tt.EMPTY_BYTE_STRING, n, Qn(), Qn(), Qn());
    }, t;
}(), Jn = function(
...
/**
     ...
     */
r) {
    this.O = t, this.removedTargetIds = e, this.key = n, this.$ = r;
}, $n = function(t, e) {
...
/** An RPC error indicating why the watch failed. */ , r) {
    ...
    function t() {
        ...
        this.q = Tt.EMPTY_BYTE_STRING, this.U = !1, 
        /**
    ...
    return t.prototype.at = function(t) {
        for (var e = 0, n = t.O; e < n.length; e++) {
            var r = n[e];
            t.$ && t.$.isFoundDocument() ? this.ut(r, t.$) : this.ct(r, t.key, t.$);
        }
    ...
    t.prototype.yt = function(t) {
        ...
        var i = new Yn(t, n, this.ot, this.it, r);
        return this.it = qn(), this.rt = nr(), this.ot = new On(ct), i;
    }, 
    /**
    ...
    t.prototype.Z = function(t) {
        ...
        var e = this.st.get(t);
        return e || (e = new tr, this.st.set(t, e)), e;
    }, t.prototype.Tt = function(t) {
        var e = this.rt.get(t);
        return e || (e = new On(ct), this.rt = this.rt.insert(t, e)), e;
    }, 
    /**
    ...
    t.prototype.dt = function(t) {
        var e = this;
        this.st.set(t, new tr), this.nt.getRemoteKeysForTarget(t).forEach((function(n) {
...
function yr(t) {
    ...
    // in the local target cache.
        return 4 === e.length ? gt.emptyPath() : gr(e);
}
...
function br(t, e, n) {
    var r = pr(t, e.name), i = hr(e.updateTime), o = new ne({
        mapValue: {
            fields: e.fields
        }
...
function Ir(t, e) {
    ...
    if (e instanceof bn) n = {
        update: wr(t, e.key, e.value)
    }; else if (e instanceof Dn) n = {
        delete: dr(t, e.key)
    }; else if (e instanceof In) n = {
        update: wr(t, e.key, e.data),
        updateMask: Rr(e.fieldMask)
    }; else {
        if (!(e instanceof An)) return G();
        n = {
            verify: dr(t, e.key)
        };
    }
...
function Er(t, e) {
    var n = e.currentDocument ? function(t) {
        return void 0 !== t.updateTime ? fn.updateTime(hr(t.updateTime)) : void 0 !== t.exists ? fn.exists(t.exists) : fn.none();
    }(e.currentDocument) : fn.none(), r = e.updateTransforms ? e.updateTransforms.map((function(e) {
        return function(t, e) {
            var n = null;
            if ("setToServerValue" in e) z("REQUEST_TIME" === e.setToServerValue), n = new en; else if ("appendMissingElements" in e) {
    ...
    if (e.update) {
        e.update.name;
        var i = pr(t, e.update.name), o = new ne({
            mapValue: {
        ...
        if (e.updateMask) {
            ...
            return new In(i, o, s, n, r);
        }
        return new bn(i, o, n, r);
    }
    if (e.delete) {
        var a = pr(t, e.delete);
        return new Dn(a, n);
...
function Sr(t, e) {
    ...
    null !== e.collectionGroup ? (n.parent = vr(t, r), n.structuredQuery.from = [ {
        collectionId: e.collectionGroup,
        allDescendants: !0
    } ]) : (n.parent = vr(t, r.popLast()), n.structuredQuery.from = [ {
...
function _r(t) {
    var e = yr(t.parent), n = t.structuredQuery, r = n.from ? n.from.length : 0, i = null;
    if (r > 0) {
        z(1 === r);
        var o = n.from[0];
    ...
    var s = [];
    n.where && (s = Nr(n.where));
    var a = [];
    n.orderBy && (a = n.orderBy.map((function(t) {
        return function(t) {
            return new De(kr(t.field), 
            // visible for testing
            function(t) {
                switch (t) {
                  case "ASCENDING":
    ...
    return n.endAt && (h = function(t) {
        var e = !t.before, n = t.values || [];
        return new Ne(n, e);
    }(n.endAt)), Me(e, i, a, s, u, "F" /* First */ , c, h);
}

function Nr(t) {
    return t ? void 0 !== t.unaryFilter ? [ Mr(t) ] : void 0 !== t.fieldFilter ? [ xr(t) ] : void 0 !== t.compositeFilter ? t.compositeFilter.filters.map((function(t) {
        return Nr(t);
    })).reduce((function(t, e) {
        return t.concat(e);
    })) : G() : [];
...
function xr(t) {
    return me.create(kr(t.fieldFilter.field), function(t) {
        switch (t) {
          case "EQUAL":
            return "==" /* EQUAL */;
...
function Mr(t) {
    switch (t.unaryFilter.op) {
      case "IS_NAN":
        var e = kr(t.unaryFilter.field);
        return me.create(e, "==" /* EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NULL":
        var n = kr(t.unaryFilter.field);
        return me.create(n, "==" /* EQUAL */ , {
            nullValue: "NULL_VALUE"
        });

      case "IS_NOT_NAN":
        var r = kr(t.unaryFilter.field);
        return me.create(r, "!=" /* NOT_EQUAL */ , {
            doubleValue: NaN
        });

      case "IS_NOT_NULL":
        var i = kr(t.unaryFilter.field);
        return me.create(i, "!=" /* NOT_EQUAL */ , {
            nullValue: "NULL_VALUE"
        });
 ...
 */ function Lr(t) {
    for (var e = "", n = 0; n < t.length; n++) e.length > 0 && (e = Fr(e)), e = Or(t.get(n), e);
    return Fr(e);
}
 ...
 * information.
 */ var Kr = {}, jr = [ "parentPath", "readTime" ], Gr = [ "canonicalId", "targetId" ], zr = [ "targetId", "path" ], Qr = [ "path", "targetId" ], Wr = [ "collectionId", "parent" ], Hr = [ "indexId", "uid" ], Yr = [ "uid", "sequenceNumber" ], Xr = [ "indexId", "uid", "arrayValue", "directionalValue", "documentKey" ], Jr = [ "indexId", "uid", "documentKey" ], $r = [ "userId", "collectionPath", "documentId" ], Zr = [ "userId", "collectionPath", "largestBatchId" ], ti = [ "userId", "collectionGroup", "largestBatchId" ], ei = e(e([], e(e([], e(e([], e(e([], [ "mutationQueues", "mutations", "documentMutations", "remoteDocuments", "targets", "owner", "targetGlobal", "targetDocuments" ]), [ "clientMetadata" ])), [ "remoteDocumentGlobal" ])), [ "collectionParents" ])), [ "bundles", "namedQueries" ]), ni = e(e([], ei), [ "documentOverlays" ]), ri = e(e([], ni), [ "indexConfiguration", "indexState", "indexEntries" ]), ii = "The current tab is not in the required state to perform this operation. It might be necessary to refresh the browser tab.", oi = /** @class */ function() {
    function t() {
    ...
    function t(t, e) {
        ...
        this.At = new X, this.transaction.oncomplete = function() {
            ...
            e.error ? n.At.reject(new hi(t, e.error)) : n.At.resolve();
        }, this.transaction.onerror = function(e) {
            var r = vi(e.target.error);
            n.At.reject(new hi(t, r));
        };
    }
    return t.open = function(e, n, r, i) {
        ...
        t && this.At.reject(t), this.aborted || (q("SimpleDb", "Aborting transaction:", t ? t.message : "Client-initiated abort"), 
    ...
    /** Deletes the specified database. */    return t.delete = function(t) {
        return q("SimpleDb", "Removing database:", t), di(window.indexedDB.deleteDatabase(t)).toPromise();
    }, 
                    ...
                    n = "readonly" === e, s = 0, a = function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return r.trys.push([ 1, 4, , 5 ]), [ 4 /*yield*/ , u.Nt(t) ];

                              case 2:
                                // Wait for the transaction to complete (i.e. IndexedDb's onsuccess event to
                                // fire), but still return the original transactionFnResult back to the
                                // caller.
                                return u.db = r.sent(), e = ai.open(u.db, t, n ? "readonly" : "readwrite", i), a = o(e).next((function(t) {
                                    return e.bt(), t;
                                })).catch((function(t) {
                                    // Abort the transaction if there was an error.
                                    return e.abort(t), si.reject(t);
                                })).toPromise(), c = {}, a.catch((function() {})), [ 4 /*yield*/ , e.Rt ];
                              ...
                              case 4:
                                return h = r.sent(), l = "FirebaseError" !== h.name && s < 3, q("SimpleDb", "Transaction failed with error:", h.message, "Retrying:", l), 
                                u.close(), l ? [ 3 /*break*/ , 5 ] : [ 2 /*return*/ , {
 ...
 */ var fi = /** @class */ function() {
    ...
    t.prototype.add = function(t) {
        return q("SimpleDb", "ADD", this.store.name, t, t), di(this.store.add(t));
    }, 
    /**
    ...
    t.prototype.get = function(t) {
        ...
        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                return di(this.store.get(t)).next((function(n) {
            // Normalize nonexistence to null.
            return void 0 === n && (n = null), q("SimpleDb", "GET", e.store.name, t, n), n;
        }));
    }, t.prototype.delete = function(t) {
        return q("SimpleDb", "DELETE", this.store.name, t), di(this.store.delete(t));
    }, 
    /**
    ...
    t.prototype.count = function() {
        return q("SimpleDb", "COUNT", this.store.name), di(this.store.count());
    }, t.prototype.Ut = function(t, e) {
    ...
    t.prototype.zt = function(t) {
        ...
        var n = [];
        return new si((function(r, i) {
            t.onerror = function(t) {
                i(t.target.error);
            }, t.onsuccess = function(t) {
                var i = t.target.result;
                if (i) {
                    var o = new ci(i), s = e(i.primaryKey, i.value, o);
                    if (s instanceof si) {
                        var a = s.catch((function(t) {
                            return o.done(), si.reject(t);
                        }));
                        n.push(a);
                    }
 ...
 */ var gi = /** @class */ function() {
    ...
    return t.prototype.applyToRemoteDocument = function(t, e) {
        for (var n = e.mutationResults, r = 0; r < this.mutations.length; r++) {
            ...
            i.key.isEqual(t.key) && vn(i, t, n[r]);
        }
    }, 
    /**
    ...
    t.prototype.applyToLocalView = function(t) {
        ...
        for (var e = 0, n = this.baseMutations; e < n.length; e++) {
            var r = n[e];
            r.key.isEqual(t.key) && yn(r, t, this.localWriteTime);
        }
        // Second, apply all user-provided mutations.
                for (var i = 0, o = this.mutations; i < o.length; i++) {
            var s = o[i];
            s.key.isEqual(t.key) && yn(s, t, this.localWriteTime);
        }
    }, 
    /**
    ...
    return t.from = function(e, n, r) {
        ...
        for (var i = Gn, o = e.mutations, s = 0; s < o.length; s++) i = i.insert(o[s].key, r[s].version);
...
/** Decodes a remote document from storage locally to a Document. */ function Ti(t, e) {
    var n;
    if (e.document) n = br(t.Jt, e.document, !!e.hasCommittedMutations); else if (e.noDocument) {
        var r = Ot.fromSegments(e.noDocument.path), i = Ai(e.noDocument.readTime);
        n = ie.newNoDocument(r, i), e.hasCommittedMutations && n.setHasCommittedMutations();
    } else {
        if (!e.unknownDocument) return G();
        var o = Ot.fromSegments(e.unknownDocument.path), s = Ai(e.unknownDocument.version);
        n = ie.newUnknownDocument(o, s);
    }
    return e.readTime && n.setReadTime(Ni(e.readTime)), n
    /** Encodes a document for storage locally. */;
}

function Si(t, e) {
    var n = e.key.path.popLast().toArray(), r = _i(e.readTime);
    ...
    if (e.isNoDocument()) {
        var o = e.key.path.toArray(), s = e.hasCommittedMutations;
        return {
            noDocument: {
                path: o,
                readTime: Di(e.version)
            },
            hasCommittedMutations: s,
            readTime: r,
            parentPath: n
        };
    }
    return e.isUnknownDocument() ? {
        unknownDocument: {
            path: e.key.path.toArray(),
            version: Di(e.version)
        },
...
/** Decodes a DbMutationBatch into a MutationBatch */ function Ci(t, e) {
    ...
    return new gi(e.batchId, a, n, s);
}

/** Decodes a DbTarget into TargetData */ function ki(t) {
    var e, n, r = Ai(t.readTime), i = void 0 !== t.lastLimboFreeSnapshotVersion ? Ai(t.lastLimboFreeSnapshotVersion) : dt.min();
    return void 0 !== t.query.documents ? (z(1 === (n = t.query).documents.length), 
    e = qe(Re(yr(n.documents[0])))) : e = function(t) {
        return qe(_r(t));
...
function xi(t, e) {
    var n, r = Di(e.snapshotVersion), i = Di(e.lastLimboFreeSnapshotVersion);
    n = ve(e.target) ? Tr(t.Jt, e.target) : Sr(t.Jt, e.target);
...
/** Encodes a DbDocumentOverlay object to an Overlay model object. */ function Ri(t, e) {
    return new bi(e.largestBatchId, Er(t.Jt, e.overlayMutation));
}
 ...
 */ var Pi = /** @class */ function() {
    ...
    return t.Yt = function(e, n) {
        ...
        var n = this;
        return Ui(t).get(Vi(this.userId, e)).next((function(t) {
            return t ? Ri(n.M, t) : null;
        }));
        ...
        e.forEach((function(t) {
            return i.add(Lr(t.getCollectionPath()));
        }));
        var o = [];
        return i.forEach((function(e) {
            ...
            /*lowerOpen=*/ !1, 
            /*upperOpen=*/ !0);
            o.push(Ui(t).Qt("collectionPathOverlayIndex", i));
        })), si.waitFor(o);
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        var r = this, i = jn(), o = Lr(e), s = IDBKeyRange.bound([ this.userId, o, n ], [ this.userId, o, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Ui(t).Ut("collectionPathOverlayIndex", s).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) {
                var o = n[e], s = Ri(r.M, o);
                i.set(s.getKey(), s);
            }
            return i;
        }));
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        var i, o = this, s = jn(), a = IDBKeyRange.bound([ this.userId, e, n ], [ this.userId, e, Number.POSITIVE_INFINITY ], 
        /*lowerOpen=*/ !0);
        return Ui(t).Wt({
            ...
            var a = Ri(o.M, e);
            s.size() < r || a.largestBatchId === i ? (s.set(a.getKey(), a), i = a.largestBatchId) : n.done();
        })).next((function() {
            return s;
        }));
    }, t.prototype.Xt = function(t, e) {
        return Ui(t).put(function(t, e, n) {
            var r = Vi(e, n.mutation.key);
            return r[0], {
                userId: e,
                collectionPath: r[1],
                documentId: r[2],
                ...
                overlayMutation: Ir(t.Jt, n.mutation)
            };
...
/** Firestore index value writer.  */ var qi = /** @class */ function() {
    function t() {}
    ...
    /** Writes an index value.  */    return t.prototype.Zt = function(t, e) {
        ...
        e.se(t.booleanValue ? 1 : 0); else if ("integerValue" in t) this.ne(e, 15), e.se(Nt(t.integerValue)); else if ("doubleValue" in t) {
            ...
            isNaN(n) ? this.ne(e, 13) : (this.ne(e, 15), Vt(n) ? 
        ...
        e.ae(Dt(t.bytesValue)), this.oe(e); else if ("referenceValue" in t) this.ue(t.referenceValue, e); else if ("geoPointValue" in t) {
        ...
        this.oe(e)) : "arrayValue" in t ? (this.he(t.arrayValue, e), this.oe(e)) : G();
        ...
        var n = this;
        this.ne(e, 37), Ot.fromName(t).path.forEach((function(t) {
            n.ne(e, 60), n.le(t, e);
        }));
...
var ji = /** @class */ function() {
    ...
    function t() {
        this.De = new ji, this.Ce = new Gi(this.De), this.xe = new zi(this.De);
    }
...
function Hi(t, e) {
    ...
    return 0 !== n ? n : 0 !== (n = Yi(t.arrayValue, e.arrayValue)) ? n : 0 !== (n = Yi(t.directionalValue, e.directionalValue)) ? n : Ot.comparator(t.documentKey, e.documentKey);
}
 ...
 */ var Xi = /** @class */ function() {
     ...
     */    return t.prototype.Fe = function(t) {
        ...
        for (var n = ae(t), r = 0, i = 0; r < n.length && this.Be(n[r]); ++r) ;
        ...
        // filter and the first orderBy clause.
                if (void 0 !== this.$e) {
            var o = n[r];
            if (!this.Le(this.$e, o) || !this.qe(this.Me[i++], o)) return !1;
            ++r;
        }
        ...
        // orderBy.
                for (;r < n.length; ++r) {
            var s = n[r];
            if (i >= this.Me.length || !this.qe(this.Me[i++], s)) return !1;
        }
        return !0;
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        return this.Ue.add(e), si.resolve();
    }, t.prototype.getCollectionParents = function(t, e) {
        return si.resolve(this.Ue.getEntries(e));
    ...
    // Returns false if the entry already existed.
        ...
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e] || new On(gt.comparator), i = !r.has(n);
        return this.index[e] = r.add(n), i;
    }, t.prototype.has = function(t) {
        var e = t.lastSegment(), n = t.popLast(), r = this.index[e];
        return r && r.has(n);
    }, t.prototype.getEntries = function(t) {
        return (this.index[t] || new On(gt.comparator)).toArray();
    }, t;
}(), Zi = new Uint8Array(0), to = /** @class */ function() {
    function t(t) {
        this.user = t, 
        /**
    ...
    return t.prototype.addToCollectionParentIndex = function(t, e) {
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return eo(t).Ut(r).next((function(t) {
        ...
        var n = this, r = no(t), i = !0, o = new Map;
        return si.forEach(this.Qe(e), (function(e) {
            ...
            if (i) {
                var t = Qn();
                return si.forEach(o, (function(i, o) {
                    var s;
                    q("IndexedDbIndexManager", "Using index " + ("id=" + (s = i).indexId + "|cg=" + s.collectionGroup + "|f=" + s.fields.map((function(t) {
                        return t.fieldPath + ":" + t.kind;
                    })).join(",") + " to execute ") + de(e));
                    var a = function(t, e) {
                        var n = se(e);
                        if (void 0 === n) return null;
                        for (var r = 0, i = ye(t, n.fieldPath); r < i.length; r++) {
                            var o = i[r];
                            switch (o.op) {
                        ...
                        for (var n = new Map, r = 0, i = ae(e); r < i.length; r++) for (var o = i[r], s = 0, a = ye(t, o.fieldPath); s < a.length; s++) {
                            var u = a[s];
                            switch (u.op) {
                              case "==" /* EQUAL */ :
                              case "in" /* IN */ :
                                ...
                                // `value != 'ab'`).
                                n.set(o.fieldPath.canonicalString(), u.value);
                                break;
                              ...
                              case "!=" /* NOT_EQUAL */ :
                                ...
                                return n.set(o.fieldPath.canonicalString(), u.value), Array.from(n.values());
                        ...
                        // startAt.
                        for (var n, r = [], i = !0, o = 0, s = ae(e); o < s.length; o++) {
                            // Process all filters to find a value for the current field segment
                            for (var a = s[o], u = void 0, c = !0, h = 0, l = ye(t, a.fieldPath); h < l.length; h++) {
                                var f = l[h], d = void 0, p = !0;
                                switch (f.op) {
                                  case "<" /* LESS_THAN */ :
                                  case "<=" /* LESS_THAN_OR_EQUAL */ :
                                    d = "nullValue" in (n = f.value) ? Pt : "booleanValue" in n ? {
                                        booleanValue: !1
                                        ...
                                        bytesValue: ""
                                    } : "referenceValue" in n ? Qt(Mt.empty(), Ot.empty()) : "geoPointValue" in n ? {
                                        geoPointValue: {
                                            latitude: -90,
                                            longitude: -180
                                        }
                            ...
                            // boundary to see if we can narrow the scope.
                                                        if (null !== t.startAt) for (var v = 0; v < t.orderBy.length; ++v) if (t.orderBy[v].field.isEqual(a.fieldPath)) {
                                var y = t.startAt.position[v];
                                te(u, y) === y && (u = y, c = t.startAt.inclusive);
                                break;
                            }
                            if (void 0 === u) 
                        ...
                        /** Returns the largest value for the given value type (exclusive). */ return new Ne(r, i);
                    }(o, i), h = function(t, e) {
                        ...
                        for (var n, r = [], i = !0, o = 0, s = ae(e); o < s.length; o++) {
                                ...
                                switch (f.op) {
                                  ...
                                  case ">" /* GREATER_THAN */ :
                                    d = "nullValue" in (n = f.value) ? {
                                        ...
                                        bytesValue: ""
                                    } : "bytesValue" in n ? Qt(Mt.empty(), Ot.empty()) : "referenceValue" in n ? {
                                        geoPointValue: {
                                            latitude: -90,
                                            longitude: -180
                                        }
                            ...
                            // boundary to see if we can narrow the scope.
                                                        if (null !== t.endAt) for (var v = 0; v < t.orderBy.length; ++v) if (t.orderBy[v].field.isEqual(a.fieldPath)) {
                                var y = t.endAt.position[v];
                                ee(u, y) === y && (u = y, c = t.endAt.inclusive);
                                break;
                            }
                            if (void 0 === u) 
                        ...
                        return new Ne(r, i);
                    }(o, i), l = n.je(i, o, c), f = n.je(i, o, h), d = n.We(i, o, u), p = n.ze(i.indexId, a, l, !!c && c.inclusive, f, !!h && h.inclusive, d);
                    return si.forEach(p, (function(n) {
                        return r.Gt(n, e.limit).next((function(e) {
                            e.forEach((function(e) {
                                t = t.add(new Ot(Pr(e.documentKey)));
                            }));
                        }));
                    }));
                })).next((function() {
    ...
    t.prototype.ze = function(t, e, n, r, i, o, s) {
        for (var a = this, u = (null != e ? e.length : 1) * Math.max(null != n ? n.length : 1, null != i ? i.length : 1), c = u / (null != e ? e.length : 1), h = [], l = function(u) {
            var l = e ? f.He(e[u / c]) : Zi, d = n ? f.Je(t, l, n[u % c], r) : f.Ye(t), p = i ? f.Xe(t, l, i[u % c], o) : f.Ye(t + 1);
            h.push.apply(h, f.createRange(d, p, s.map((function(e) {
                return a.Je(t, l, e, 
                /* inclusive= */ !0);
            }))));
        }, f = this, d = 0
    ...
    t.prototype.Ye = function(t) {
        return new Wi(t, Ot.empty(), Zi, Zi);
    }, t.prototype.getFieldIndex = function(t, e) {
        var n = new Xi(e), r = null != e.collectionGroup ? e.collectionGroup : e.path.lastSegment();
    ...
    t.prototype.Ze = function(t, e) {
        for (var n = new Qi, r = 0, i = ae(t); r < i.length; r++) {
    ...
    /** Encodes a single value to the ascending index format. */ t.prototype.He = function(t) {
        var e = new Qi;
        return qi.fe.Zt(t, e.Ne(0 /* ASCENDING */)), e.Se();
    }, 
    /**
    ...
    t.prototype.We = function(t, e, n) {
        ...
        var r = [];
        r.push(new Qi);
        for (var i = 0, o = 0, s = ae(t); o < s.length; o++) for (var a = s[o], u = n[i++], c = 0, h = r; c < h.length; c++) {
            var l = h[c];
            if (this.tn(e, a.fieldPath) && Ht(u)) r = this.en(r, a, u); else {
                var f = l.Ne(a.kind);
                qi.fe.Zt(u, f);
            }
        }
    ...
    t.prototype.en = function(t, n, r) {
        for (var i = e([], t), o = [], s = 0, a = r.arrayValue.values || []; s < a.length; s++) for (var u = a[s], c = 0, h = i; c < h.length; c++) {
            var l = h[c], f = new Qi;
            f.seed(l.Se()), qi.fe.Zt(u, f.Ne(n.kind)), o.push(f);
        }
        return o;
    }, t.prototype.tn = function(t, e) {
        return !!t.filters.find((function(t) {
            return t instanceof me && t.field.isEqual(e) && ("in" /* IN */ === t.op || "not-in" /* NOT_IN */ === t.op);
        }));
    }, t.prototype.getFieldIndexes = function(t, e) {
        var n = this, r = ro(t), i = io(t);
        return (e ? r.Ut("collectionGroupIndex", IDBKeyRange.bound(e, e)) : r.Ut()).next((function(t) {
            var e = [];
            return si.forEach(t, (function(t) {
                return i.get([ t.indexId, n.uid ]).next((function(n) {
                    e.push(function(t, e) {
                        var n = e ? new ce(e.sequenceNumber, new he(Ai(e.readTime), new Ot(Pr(e.documentKey)), e.largestBatchId)) : ce.empty(), r = t.fields.map((function(t) {
                            var e = t[0], n = t[1];
                            return new ue(bt.fromServerFormat(e), n);
                        }));
        ...
        var r = this, i = ro(t), o = io(t);
        return this.sn(t).next((function(t) {
            return i.Ut("collectionGroupIndex", IDBKeyRange.bound(e, e)).next((function(e) {
                return si.forEach(e, (function(e) {
                    return o.put(function(t, e, n, r) {
                        return {
                            ...
                            uid: e.uid || "",
                            sequenceNumber: n,
                            readTime: Di(r.readTime),
                            documentKey: Lr(r.documentKey.path),
        ...
        // here.
                return si.forEach(e, (function(e, i) {
            var o = r.get(e.collectionGroup);
            return (o ? si.resolve(o) : n.getFieldIndexes(t, e.collectionGroup)).next((function(o) {
                return r.set(e.collectionGroup, o), si.forEach(o, (function(r) {
                    return n.rn(t, e, r).next((function(e) {
                        var o = n.on(i, r);
                        return e.isEqual(o) ? si.resolve() : n.an(t, i, e, o);
                    }));
                }));
            }));
        }));
        ...
        return no(t).put({
            ...
            documentKey: Lr(e.key.path)
        });
    }, t.prototype.cn = function(t, e, n) {
        return no(t).delete([ n.indexId, this.uid, n.arrayValue, n.directionalValue, Lr(e.key.path) ]);
    }, t.prototype.rn = function(t, e, n) {
        var r = no(t), i = new On(Hi);
        return r.Wt({
            index: "documentKeyIndex",
            range: IDBKeyRange.only([ n.indexId, this.uid, Lr(e.path) ])
        }, (function(t, r) {
            i = i.add(new Wi(n.indexId, e, r.arrayValue, r.directionalValue));
        })).next((function() {
            return i;
        }));
    }, 
    /** Creates the index entries for the given document. */ t.prototype.on = function(t, e) {
        var n = new On(Hi), r = this.Ze(e, t);
        if (null == r) return n;
        var i = se(e);
        if (null != i) {
            var o = t.data.field(i.fieldPath);
            if (Ht(o)) for (var s = 0, a = o.arrayValue.values || []; s < a.length; s++) {
                var u = a[s];
                n = n.add(new Wi(e.indexId, t.key, this.He(u), r));
            }
        } else n = n.add(new Wi(e.indexId, t.key, Zi, r));
        return n;
    }, 
    /**
     ...
     * entries.
     */
    t.prototype.an = function(t, e, n, r) {
        var i = this;
        q("IndexedDbIndexManager", "Updating index entries for document '%s'", e.key);
        var o = [];
        return function(t, e, n, r, i) {
            // Walk through the two sets at the same time, using the ordering defined by
            // `comparator`.
            for (var o = t.getIterator(), s = e.getIterator(), a = Pn(o), u = Pn(s); a || u; ) {
                var c = !1, h = !1;
                if (a && u) {
                    var l = n(a, u);
                    l < 0 ? 
                ...
                c ? (r(u), u = Pn(s)) : h ? (i(a), a = Pn(o)) : (a = Pn(o), u = Pn(s));
            }
        }(n, r, Hi, (
        /* onAdd= */ function(n) {
            o.push(i.un(t, e, n));
    ...
    t.prototype.createRange = function(t, e, n) {
        ...
        n = n.sort((function(t, e) {
            ...
            return !e || 0 !== Hi(t, n[e - 1]);
        }));
        var r = [];
        r.push(t);
        for (var i = 0, o = n; i < o.length; i++) {
            var s = o[i], a = Hi(s, t), u = Hi(s, e);
            if (0 === a) 
            // `notInValue` is the lower bound. We therefore need to raise the bound
            // to the next value.
            r[0] = t.ke(); else if (a > 0 && u < 0) 
            // `notInValue` is in the middle of the range
            r.push(s), r.push(s.ke()); else if (u > 0) 
            // `notInValue` (and all following values) are out of the range
            break;
        }
        r.push(e);
        for (var c = [], h = 0; h < r.length; h += 2) c.push(IDBKeyRange.bound([ r[h].indexId, this.uid, r[h].arrayValue, r[h].directionalValue, "" ], [ r[h + 1].indexId, this.uid, r[h + 1].arrayValue, r[h + 1].directionalValue, "" ]));
        return c;
    }, t;
}();
 ...
 */
function ao(t, e, n) {
    var r = t.store("mutations"), i = t.store("documentMutations"), o = [], s = IDBKeyRange.only(n.batchId), a = 0, u = r.Wt({
        range: s
    }, (function(t, e, n) {
        return a++, n.delete();
    }));
    ...
    for (var c = [], h = 0, l = n.mutations; h < l.length; h++) {
        var f = l[h], d = Br(e, f.key.path, n.batchId);
        o.push(i.delete(d)), c.push(f.key);
    }
    return si.waitFor(o).next((function() {
        return c;
    }));
}
...
var co = /** @class */ function() {
    ...
    return t.Yt = function(e, n, r, i) {
        ...
        return s.add({}).next((function(a) {
            z("number" == typeof a);
            for (var u = new gi(a, e, n, r), c = function(t, e, n) {
            ...
            }(i.M, i.userId, u), h = [], l = new On((function(t, e) {
                return ct(t.canonicalString(), e.canonicalString());
            })), f = 0, d = r; f < d.length; f++) {
                var p = d[f], v = Br(i.userId, p.key.path, a);
                l = l.add(p.key.path.popLast()), h.push(s.put(c)), h.push(o.put(v, Kr));
            }
            return l.forEach((function(e) {
                h.push(i.indexManager.addToCollectionParentIndex(t, e));
            })), t.addOnCommittedListener((function() {
                i.hn[a] = u.keys();
            })), si.waitFor(h).next((function() {
                return u;
            }));
        }));
        ...
        return lo(t).get(e).next((function(t) {
            return t ? (z(t.userId === n.userId), Ci(n.M, t)) : null;
        }));
    }, 
    /**
    ...
    t.prototype.ln = function(t, e) {
        var n = this;
        return this.hn[e] ? si.resolve(this.hn[e]) : this.lookupMutationBatch(t, e).next((function(t) {
            if (t) {
                var r = t.keys();
                return n.hn[e] = r, r;
            }
        ...
        return lo(t).Wt({
            ...
            e.userId === n.userId && (z(e.batchId >= r), o = Ci(n.M, e)), i.done();
        })).next((function() {
            return o;
        }));
        ...
        return lo(t).Ut("userMutationsIndex", n).next((function(t) {
        ...
        // the given documentKey.
            ...
            return lo(t).get(c).next((function(t) {
                if (!t) throw G();
                z(t.userId === n.userId), o.push(Ci(n.M, t));
            }));
            s.done();
        })).next((function() {
            return o;
        ...
        var n = this, r = new On(ct), i = [];
        return e.forEach((function(e) {
            var o = qr(n.userId, e.path), s = IDBKeyRange.lowerBound(o), a = fo(t).Wt({
                range: s
            }, (function(t, i, o) {
                var s = t[0], a = t[1], u = t[2], c = Pr(a);
                // Only consider rows matching exactly the specific key of
                // interest. Note that because we order by path first, and we
                // order terminators before path separators, we'll encounter all
                // the index rows for documentKey contiguously. In particular, all
            ...
            i.push(a);
        })), si.waitFor(i).next((function() {
            return n.fn(t, r);
        }));
    }, t.prototype.getAllMutationBatchesAffectingQuery = function(t, e) {
        var n = this, r = e.path, i = r.length + 1, o = qr(this.userId, r), s = IDBKeyRange.lowerBound(o), a = new On(ct);
        return fo(t).Wt({
            range: s
        }, (function(t, e, o) {
            var s = t[0], u = t[1], c = t[2], h = Pr(u);
        ...
        return e.forEach((function(e) {
            i.push(lo(t).get(e).next((function(t) {
                if (null === t) throw G();
                z(t.userId === n.userId), r.push(Ci(n.M, t));
            })));
        })), si.waitFor(i).next((function() {
            return r;
        }));
        ...
        var n = this;
        return ao(t.Ht, this.userId, e).next((function(r) {
            return t.addOnCommittedListener((function() {
                n.dn(e.batchId);
            })), si.forEach(r, (function(e) {
    ...
    t.prototype._n = function(t) {
        var e = this;
        return po(t).get(this.userId).next((function(t) {
            return t || {
                userId: e.userId,
 ...
 */ function ho(t, e, n) {
    var r = qr(e, n.path), i = r[1], o = IDBKeyRange.lowerBound(r), s = !1;
    return fo(t).Wt({
        range: o,
        jt: !0
    }, (function(t, n, r) {
 ...
 */ var vo = /** @class */ function() {
    ...
    // out to have a meaningful performance impact.
        ...
        return this.yn(t).next((function(n) {
            var r = new vo(n.highestTargetId);
     ...
     */
    t.prototype.forEachTarget = function(t, e) {
        return mo(t).Wt((function(t, n) {
            var r = ki(n);
            e(r);
        }));
    }, t.prototype.yn = function(t) {
        return go(t).get("targetGlobalKey").next((function(t) {
            return z(null !== t), t;
        }));
    }, t.prototype.pn = function(t, e) {
        return go(t).put("targetGlobalKey", e);
    }, t.prototype.In = function(t, e) {
        return mo(t).put(xi(this.M, e));
    }, 
    /**
    ...
    t.prototype.Tn = function(t, e) {
        ...
        var n = de(e), r = IDBKeyRange.bound([ n, Number.NEGATIVE_INFINITY ], [ n, Number.POSITIVE_INFINITY ]), i = null;
        return mo(t).Wt({
            range: r,
        ...
        // IndexedDb.
                return si.forEach(e, (function(e) {
            var o = Lr(e.path);
            return si.waitFor([ i.delete([ n, o ]), r.referenceDelegate.removeReference(t, n, e) ]);
        }));
    }, t.prototype.removeMatchingKeysForTargetId = function(t, e) {
        var n = wo(t), r = IDBKeyRange.bound([ e ], [ e + 1 ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0);
        return n.delete(r);
        ...
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), r = wo(t), i = Qn();
        return r.Wt({
            range: n,
            jt: !0
        }, (function(t, e, n) {
            var r = Pr(t[1]), o = new Ot(r);
            i = i.add(o);
        })).next((function() {
            return i;
        }));
    }, t.prototype.containsKey = function(t, e) {
        var n = Lr(e.path), r = IDBKeyRange.bound([ n ], [ lt(n) ], 
        /*lowerOpen=*/ !1, 
        /*upperOpen=*/ !0), i = 0;
        return wo(t).Wt({
 ...
 */ function bo(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            if (t.code !== H.FAILED_PRECONDITION || t.message !== ii) throw t;
 ...
 */ var Eo = /** @class */ function() {
    function t(t) {
        this.En = t, this.buffer = new On(Io), this.An = 0;
    }
    return t.prototype.Rn = function() {
        ...
        if (this.buffer.size < this.En) this.buffer = this.buffer.add(e); else {
            ...
            Io(e, n) < 0 && (this.buffer = this.buffer.delete(n).add(e));
        }
    ...
    return t.prototype.start = function(t) {
        ...
        q("LruGarbageCollector", "Garbage collection scheduled in " + i + "ms"), this.Vn = this.asyncQueue.enqueueAfterDelay("lru_garbage_collection" /* LruGarbageCollection */ , i, (function() {
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      ...
                      case 3:
                        return li(e = n.sent()) ? (q("LruGarbageCollector", "Ignoring IndexedDB error during garbage collection: ", e), 
                        [ 3 /*break*/ , 6 ]) : [ 3 /*break*/ , 4 ];
    ...
    return t.prototype.calculateTargetCount = function(t, e) {
        ...
        si.resolve(oo)) : this.getCacheSize(t).next((function(r) {
        ...
        return this.calculateTargetCount(t, this.params.percentileToCollect).next((function(e) {
            ...
            return u = Date.now(), P() <= l.DEBUG && q("LruGarbageCollector", "LRU Garbage Collection\n\tCounted targets in " + (o - h) + "ms\n\tDetermined least recently used " + r + " in " + (s - o) + "ms\n\tRemoved " + i + " targets in " + (a - s) + "ms\n\tRemoved " + t + " documents in " + (u - a) + "ms\nTotal Duration: " + (u - h) + "ms"), 
            si.resolve({
                didRun: !0,
    ...
    t.prototype.Mn = function(t, e) {
        return function(t, e) {
            var n = !1;
            return po(t).zt((function(r) {
                return ho(t, r, e).next((function(t) {
                    return t && (n = !0), si.resolve(!t);
                }));
            })).next((function() {
                return n;
            }));
        ...
        return this.kn(t, (function(s, a) {
            if (a <= e) {
                var u = n.Mn(t, s).next((function(e) {
                    if (!e) 
                    // Our size accounting requires us to read all documents before
                    // removing them.
                    return o++, r.getEntry(t, s).next((function() {
                        return r.removeEntry(s, dt.min()), wo(t).delete([ 0, Lr(s.path) ]);
                    }));
                }));
                i.push(u);
            }
 ...
 */ var Do = /** @class */ function() {
    function t() {
        ...
        this.changes = new Mn((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
    ...
    t.prototype.updateMetadata = function(t, e) {
        ...
        var n = this;
        return xo(t).get(Mo(e)).next((function(t) {
            return n.$n(e, t);
        }));
    }, 
    /**
     ...
     */
    t.prototype.Ln = function(t, e) {
        var n = this, r = qn(), i = new Rn(Ot.comparator);
        return this.Bn(t, e, (function(t, e) {
            var o = n.$n(t, e);
            r = r.insert(t, o), i = i.insert(t, uo(e));
        })).next((function() {
            return {
                documents: r,
                qn: i
        ...
        return xo(t).Wt({
            ...
            for (var s = Ot.fromSegments(t); o && Ot.comparator(o, s) < 0; ) n(o, null), o = i.getNext();
            o && o.isEqual(s) && (
            // Key found in cache.
            n(o, e), o = i.hasNext() ? i.getNext() : null), 
            // Skip to the next key (if there is one).
            o ? r.qt(o.path.toArray()) : r.done();
        })).next((function() {
        ...
        var r = this, i = qn(), o = e.length + 1, s = {};
        if (n.isEqual(dt.min())) {
            ...
            var u = e.toArray(), c = _i(n);
            s.range = IDBKeyRange.lowerBound([ u, c ], 
            /* open= */ !0), s.index = "collectionReadTimeIndex";
        }
        return xo(t).Wt(s, (function(t, n, s) {
            ...
            if (t.length === o) {
                var a = r.$n(Ot.fromSegments(t), n);
                e.isPrefixOf(a.key.path) ? i = i.insert(a.key, a) : s.done();
            }
        })).next((function() {
            return i;
        }));
    }, t.prototype.newChangeBuffer = function(t) {
        return new Co(this, !!t && t.trackRemovals);
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).Un = t, r.trackRemovals = n, 
        // A map of document sizes prior to applying the changes in this buffer.
        r.Kn = new Mn((function(t) {
            return t.toString();
        }), (function(t, e) {
            return t.isEqual(e);
        })), r;
    ...
    return t(n, e), n.prototype.applyChanges = function(t) {
        ...
        return this.changes.forEach((function(o, s) {
            ...
            if (s.isValidDocument()) {
                ...
                var c = uo(u);
                r += c - a, n.push(e.Un.addEntry(t, o, u));
            } else if (r -= a, e.trackRemovals) {
                // In order to track removals, we store a "sentinel delete" in the
                // RemoteDocumentCache. This entry is represented by a NoDocument
                // with a version of 0 and ignored by `maybeDecodeDocument()` but
                // preserved in `getNewDocumentChanges()`.
                var h = Si(e.Un.M, s.convertToNoDocument(dt.min()));
                n.push(e.Un.addEntry(t, o, h));
            } else n.push(e.Un.removeEntry(t, o));
        })), i.forEach((function(r) {
            n.push(e.Un.indexManager.addToCollectionParentIndex(t, r));
        })), n.push(this.Un.updateMetadata(t, r)), si.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute a delta later.
                return this.Un.Fn(t, e).next((function(t) {
            return n.Kn.set(e, t.size), t.document;
        }));
    }, n.prototype.getAllFromCache = function(t, e) {
        var n = this;
        // Record the size of everything we load from the cache so we can compute
        // a delta later.
                return this.Un.Ln(t, e).next((function(t) {
            var e = t.documents;
            // Note: `getAllFromCache` returns two maps instead of a single map from
            // keys to `DocumentSizeEntry`s. This is to allow returning the
            // `MutableDocumentMap` directly, without a conversion.
            return t.qn.forEach((function(t, e) {
                n.Kn.set(t, e);
            })), e;
        }));
    }, n;
 ...
 * limitations under the License.
 */
/** Performs database creation and schema upgrades. */ var Ro = /** @class */ function() {
    function t(t) {
        this.M = t;
    }
    /**
     ...
     */    return t.prototype.kt = function(t, e, n, r) {
        var i = this, o = new ai("createOrUpgrade", e);
        n < 1 && r >= 1 && (function(t) {
            ...
            t.createObjectStore("mutationQueues", {
                ...
                keyPath: "batchId",
                autoIncrement: !0
            }).createIndex("userMutationsIndex", Ur, {
                unique: !0
     ...
     */
        ...
        s = s.next((function() {
            return function(t, e) {
                return e.store("mutations").Ut().next((function(n) {
            ...
            !function(t) {
                ...
                var e = t.objectStore("remoteDocuments");
                e.createIndex("readTimeIndex", "readTime", {
                    unique: !1
                }), e.createIndex("collectionReadTimeIndex", jr, {
                    unique: !1
                });
            }(e);
            ...
            !function(t) {
                ...
                e.createIndex("collectionPathOverlayIndex", Zr, {
                    unique: !1
            ...
            !function(t) {
                t.createObjectStore("indexConfiguration", {
                    ...
                    keyPath: Hr
                }).createIndex("sequenceNumberIndex", Yr, {
                    unique: !1
                }), t.createObjectStore("indexEntries", {
                    keyPath: Xr
                }).createIndex("documentKeyIndex", Jr, {
                    unique: !1
                });
            }(t);
        }))), s;
        ...
        return n.Ut().next((function(n) {
            return si.forEach(n, (function(n) {
                var i = IDBKeyRange.bound([ n.userId, -1 ], [ n.userId, n.lastAcknowledgedBatchId ]);
                return r.Ut("userMutationsIndex", i).next((function(r) {
                    return si.forEach(r, (function(r) {
                        z(r.userId === n.userId);
                        var i = Ci(e.M, r);
                        return ao(t, n.userId, i).next((function() {}));
                    }));
                }));
            }));
        }));
    ...
    t.prototype.jn = function(t) {
        ...
        return t.store("targetGlobal").get("targetGlobalKey").next((function(t) {
            ...
            return n.Wt((function(n, i) {
                ...
                r.push(e.get(s).next((function(n) {
                    return n ? si.resolve() : function(n) {
                        return e.put({
                            targetId: 0,
                            path: Lr(n),
        ...
        var n = e.store("collectionParents"), r = new $i, i = function(t) {
            if (r.add(t)) {
...
function Vo(t) {
    t.createObjectStore("targetDocuments", {
        keyPath: zr
    }).createIndex("documentTargetsIndex", Qr, {
        unique: !0
    }), 
    // NOTE: This is unique only because the TargetId is the suffix.
    t.createObjectStore("targets", {
        keyPath: "targetId"
    }).createIndex("queryTargetsIndex", Gr, {
        unique: !0
    }), t.createObjectStore("targetGlobal");
}

var Lo = "Failed to obtain exclusive access to the persistence layer. To allow shared access, multi-tab synchronization has to be enabled in all tabs. If you are using `experimentalForceOwningTab:true`, make sure that only one tab has persistence enabled at any given time.", Oo = /** @class */ function() {
    function t(
    /**
    ...
    h, l) {
        ...
        this.clientId = r, this.Hn = o, this.window = s, this.document = a, this.Jn = c, 
        this.Yn = h, this.Xn = l, this.Zn = null, this.ts = !1, this.isPrimary = !1, this.networkEnabled = !0, 
        ...
        this.referenceDelegate = new _o(this, i), this.us = n + "main", this.M = new Ei(u), 
        this.cs = new ui(this.us, this.Xn, new Ro(this.M)), this.hs = new yo(this.referenceDelegate, this.M), 
        this.ls = function(t) {
            return new Ao(t);
        }(this.M), this.fs = new Li, this.window && this.window.localStorage ? this.ds = this.window.localStorage : (this.ds = null, 
     ...
     */    return t.prototype.start = function() {
        ...
        // do.
                return this._s().then((function() {
            if (!t.isPrimary && !t.allowTabSynchronization) 
            // Fail `start()` if `synchronizeTabs` is disabled and we cannot
            // obtain the primary lease.
            throw new Y(H.FAILED_PRECONDITION, Lo);
            return t.ws(), t.gs(), t.ys(), t.runTransaction("getHighestListenSequenceNumber", "readonly", (function(e) {
                return t.hs.getHighestSequenceNumber(e);
            }));
        })).then((function(e) {
            t.Zn = new st(e, t.Jn);
        })).then((function() {
            ...
            return t.cs && t.cs.close(), Promise.reject(e);
        }));
    }, 
    /**
    ...
    t.prototype.setNetworkEnabled = function(t) {
        ...
        this.Hn.enqueueAndForget((function() {
            return n(e, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return this.started ? [ 4 /*yield*/ , this._s() ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype._s = function() {
        ...
        return this.runTransaction("updateClientMetadataAndTryBecomePrimary", "readwrite", (function(e) {
            return Po(e).put({
                ...
                if (t.isPrimary) return t.Is(e).next((function(e) {
                    e || (t.isPrimary = !1, t.Hn.enqueueRetryable((function() {
                        return t.os(!1);
                    })));
                }));
            })).next((function() {
                ...
                return t.isPrimary && !n ? t.Es(e).next((function() {
                    return !1;
                })) : !!n && t.As(e).next((function() {
                    return !0;
                }));
            }));
        })).catch((function(e) {
            ...
            t.isPrimary !== e && t.Hn.enqueueRetryable((function() {
                return t.os(e);
            })), t.isPrimary = e;
        }));
    }, t.prototype.Is = function(t) {
        var e = this;
        return Fo(t).get("owner").next((function(t) {
            return si.resolve(e.Rs(t));
        }));
    ...
    t.prototype.Ps = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return !this.isPrimary || this.Vs(this.rs, 18e5) ? [ 3 /*break*/ , 2 ] : (this.rs = Date.now(), 
                    [ 4 /*yield*/ , this.runTransaction("maybeGarbageCollectMultiClientState", "readwrite-primary", (function(t) {
                        var e = mi(t, "clientMetadata");
                        return e.Ut().next((function(t) {
                            var n = o.vs(t, 18e5), r = t.filter((function(t) {
                  ...
                  case 1:
                    ...
                    if (t = r.sent(), this.ds) for (e = 0, n = t; e < n.length; e++) i = n[e], this.ds.removeItem(this.Ss(i.clientId));
                    r.label = 2;
    ...
    t.prototype.ys = function() {
        var t = this;
        this.ss = this.Hn.enqueueAfterDelay("client_metadata_refresh" /* ClientMetadataRefresh */ , 4e3, (function() {
            return t._s().then((function() {
                return t.Ps();
            })).then((function() {
                return t.ys();
            }));
    ...
    /** Checks whether `client` is the local client. */ t.prototype.Rs = function(t) {
    ...
    t.prototype.Ts = function(t) {
        var e = this;
        return this.Yn ? si.resolve(!0) : Fo(t).get("owner").next((function(n) {
            ...
            if (null !== n && e.Vs(n.leaseTimestampMs, 5e3) && !e.Ds(n.ownerId)) {
                if (e.Rs(n) && e.networkEnabled) return !0;
                if (!e.Rs(n)) {
            ...
            return !(!e.networkEnabled || !e.inForeground) || Po(t).Ut().next((function(t) {
                return void 0 === e.vs(t, 5e3).find((function(t) {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    ...
                    return this.ts = !1, this.Cs(), this.ss && (this.ss.cancel(), this.ss = null), this.xs(), 
                    this.Ns(), [ 4 /*yield*/ , this.cs.runTransaction("shutdown", "readwrite", [ "owner", "clientMetadata" ], (function(e) {
                        var n = new yi(e, st.A);
                        return t.Es(n).next((function() {
                            return t.bs(n);
                        }));
                    })) ];
    ...
    t.prototype.vs = function(t, e) {
        ...
        return t.filter((function(t) {
            return n.Vs(t.updateTimeMs, e) && !n.Ds(t.clientId);
        }));
    }, 
    /**
    ...
    t.prototype.Ms = function() {
        ...
        return this.runTransaction("getActiveClients", "readonly", (function(e) {
            return Po(e).Ut().next((function(e) {
                return t.vs(e, 18e5).map((function(t) {
                    return t.clientId;
                }));
            }));
        }));
        ...
        return co.Yt(t, this.M, e, this.referenceDelegate);
        ...
        return Pi.Yt(this.M, t);
    }, t.prototype.getBundleCache = function() {
        return this.fs;
    }, t.prototype.runTransaction = function(t, e, n) {
        var r = this;
        q("IndexedDbPersistence", "Starting transaction:", t);
        var i, o, s = "readonly" === e ? "readonly" : "readwrite", a = 13 === (i = this.Xn) ? ri : 12 === i ? ni : 11 === i ? ei : void G();
        /** Returns the object stores for the provided schema. */        
        // Do all transactions as readwrite against all object stores, since we
        // are the only reader/writer.
        return this.cs.runTransaction(t, s, a, (function(i) {
            return o = new yi(i, r.Zn ? r.Zn.next() : st.A), "readwrite-primary" === e ? r.Is(o).next((function(t) {
                return !!t || r.Ts(o);
            })).next((function(e) {
                if (!e) throw B("Failed to obtain primary lease for action '" + t + "'."), r.isPrimary = !1, 
                r.Hn.enqueueRetryable((function() {
                    return r.os(!1);
                })), new Y(H.FAILED_PRECONDITION, ii);
                return n(o);
            })).next((function(t) {
                return r.As(o).next((function() {
                    return t;
                }));
            })) : r.Os(o).next((function() {
                return n(o);
            }));
        })).then((function(t) {
    ...
    t.prototype.Os = function(t) {
        var e = this;
        return Fo(t).get("owner").next((function(t) {
            if (null !== t && e.Vs(t.leaseTimestampMs, 5e3) && !e.Ds(t.ownerId) && !e.Rs(t) && !(e.Yn || e.allowTabSynchronization && t.allowTabSynchronization)) throw new Y(H.FAILED_PRECONDITION, Lo);
        }));
    }, 
    /**
    ...
    /** Checks the primary lease and removes it if we are the current primary. */ t.prototype.Es = function(t) {
        var e = this, n = Fo(t);
        return n.get("owner").next((function(t) {
            return e.Rs(t) ? (q("IndexedDbPersistence", "Releasing primary lease."), n.delete("owner")) : si.resolve();
        }));
    }, 
    /** Verifies that `updateTimeMs` is within `maxAgeMs`. */ t.prototype.Vs = function(t, e) {
        ...
        var t = this;
        null !== this.document && "function" == typeof this.document.addEventListener && (this.ns = function() {
            t.Hn.enqueueAndForget((function() {
                return t.inForeground = "visible" === t.document.visibilityState, t._s();
            }));
    ...
    t.prototype.gs = function() {
        var t, e = this;
        "function" == typeof (null === (t = this.window) || void 0 === t ? void 0 : t.addEventListener) && (this.es = function() {
            // Note: In theory, this should be scheduled on the AsyncQueue since it
            // accesses internal state. We execute this code directly during shutdown
            // to make sure it gets a chance to run.
            e.Cs(), p() && navigator.appVersion.match(/Version\/1[45]/) && 
            // On Safari 14 and 15, we do not run any cleanup actions as it might
            // trigger a bug that prevents Safari from re-opening IndexedDB during
            // the next page load.
            // See https://bugs.webkit.org/show_bug.cgi?id=226547
            e.Hn.enterRestrictedMode(/* purgeExistingTasks= */ !0), e.Hn.enqueueAndForget((function() {
                return e.shutdown();
            }));
    ...
    t.prototype.Ds = function(t) {
        var e;
        try {
            var n = null !== (null === (e = this.ds) || void 0 === e ? void 0 : e.getItem(this.Ss(t)));
    ...
    /** Removes the zombied client entry if it exists. */ t.prototype.ks = function() {
        if (this.ds) try {
...
var qo = function(t, e) {
    ...
    return t.prototype.Bs = function(t, e) {
        var n = this;
        return this.Fs.getAllMutationBatchesAffectingDocumentKey(t, e).next((function(r) {
            return n.Ls(t, e, r);
        }));
    }, 
    /** Internal version of `getDocument` that allows reusing batches. */ t.prototype.Ls = function(t, e, n) {
        return this.ls.getEntry(t, e).next((function(t) {
    ...
    t.prototype.Us = function(t, e) {
        var n = this;
        return this.ls.getEntries(t, e).next((function(e) {
            return n.Ks(t, e).next((function() {
                return e;
            }));
        }));
    }, 
    ...
    t.prototype.Ks = function(t, e) {
        var n = this;
        return this.Fs.getAllMutationBatchesAffectingDocumentKeys(t, e).next((function(t) {
            return n.qs(e, t);
        }));
    }, 
    /**
 ...
 */
        return function(t) {
            return Ot.isDocumentKey(t.path) && null === t.collectionGroup && 0 === t.filters.length;
        }(e) ? this.Qs(t, e.path) : Pe(e) ? this.js(t, e, n) : this.Ws(t, e, n);
    }, t.prototype.Qs = function(t, e) {
        // Just do a simple document lookup.
        return this.Bs(t, new Ot(e)).next((function(t) {
            var e = Kn();
        ...
        return this.indexManager.getCollectionParents(t, i).next((function(s) {
            return si.forEach(s, (function(s) {
                ...
                return r.Ws(t, a, n).next((function(t) {
                    t.forEach((function(t, e) {
                        o = o.insert(t, e);
                    }));
                }));
        ...
        // Query the remote documents and overlay mutations.
                return this.ls.getAll(t, e.path, n).next((function(n) {
            return r = n, i.Fs.getAllMutationBatchesAffectingQuery(t, e);
        })).next((function(t) {
            for (var e = 0, n = t; e < n.length; e++) for (var i = n[e], o = 0, s = i.mutations; o < s.length; o++) {
                var a = s[o], u = a.key, c = r.get(u);
                null == c && (
                // Create invalid document to apply mutations on top of
                c = ie.newInvalidDocument(u), r = r.insert(u, c)), yn(a, c, i.localWriteTime), c.isFoundDocument() || (r = r.remove(u));
            }
        })).next((function() {
    ...
    return t.Js = function(e, n) {
        for (var r = Qn(), i = Qn(), o = 0, s = n.docChanges; o < s.length; o++) {
            var a = s[o];
            switch (a.type) {
              case 0 /* Added */ :
                r = r.add(a.doc.key);
    ...
    /** Returns all local documents matching the specified query. */ t.prototype.Gs = function(t, e, n, r) {
        var i = this;
        ...
        }(e) || n.isEqual(dt.min()) ? this.Zs(t, e) : this.Xs.Us(t, r).next((function(o) {
            var s = i.ti(e, o);
            return (Ve(e) || Le(e)) && i.ei(e.limitType, s, r, n) ? i.Zs(t, e) : (P() <= l.DEBUG && q("QueryEngine", "Re-using previous result from %s to execute query: %s", n.toString(), Ge(e)), 
            i.Xs.Gs(t, e, n).next((function(t) {
    ...
    t.prototype.ei = function(t, e, n, r) {
        ...
        return P() <= l.DEBUG && q("QueryEngine", "Using full collection scan to execute query:", Ge(e)), 
        this.Xs.Gs(t, e, dt.min());
    }, t;
}(), Go = /** @class */ function() {
    function t(
    ...
    t, e, n, r) {
        ...
        /**
             ...
             */
        this.ri = dt.min(), this.oi = t.getRemoteDocumentCache(), this.hs = t.getTargetCache(), 
    ...
    return t.prototype.ai = function(t) {
        ...
        this.ui = new Bo(this.oi, this.Fs, this.indexManager), this.oi.setIndexManager(this.indexManager), 
        this.ni.Ys(this.ui);
            ...
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , (n = W(t)).persistence.runTransaction("Handle user change", "readonly", (function(t) {
                    ...
                    // before and after.
                    var r;
                    return n.Fs.getAllMutationBatches(t).next((function(i) {
                        return r = i, n.ai(e), n.Fs.getAllMutationBatches(t);
                    })).next((function(e) {
                        for (var i = [], o = [], s = Qn(), a = 0, u = r
                        ...
                        // of mutation batch IDs that were affected by change.
                                                return n.ui.Us(t, s).next((function(t) {
                            return {
                                ci: t,
                                removedBatchIds: i,
                                addedBatchIds: o
 ...
 */ function Wo(t, e) {
    ...
    return n.persistence.runTransaction("Acknowledge batch", "readwrite-primary", (function(t) {
        ...
        return function(t, e, n, r) {
            var i = n.batch, o = i.keys(), s = si.resolve();
            return o.forEach((function(t) {
                ...
                return t.Fs.removeMutationBatch(e, i);
            }));
        }(n, t, e, i).next((function() {
            return i.apply(t);
        })).next((function() {
            return n.Fs.performConsistencyCheck(t);
        })).next((function() {
            return n.ui.Us(t, r);
        }));
    }));
 ...
 */ function Ho(t) {
    ...
    return e.persistence.runTransaction("Get last remote snapshot version", "readonly", (function(t) {
        return e.hs.getLastRemoteSnapshotVersion(t);
    }));
}
 ...
 */ function Yo(t, e) {
    ...
    return n.persistence.runTransaction("Apply remote event", "readwrite-primary", (function(t) {
        ...
        e.targetChanges.forEach((function(o, a) {
            ...
            if (u) {
                ...
                s.push(n.hs.removeMatchingKeys(t, o.removedDocuments, a).next((function() {
                    return n.hs.addMatchingKeys(t, o.addedDocuments, a);
                })));
                var c = u.withSequenceNumber(t.currentSequenceNumber);
                e.targetMismatches.has(a) ? c = c.withResumeToken(Tt.EMPTY_BYTE_STRING, dt.min()).withLastLimboFreeSnapshotVersion(dt.min()) : o.resumeToken.approximateByteSize() > 0 && (c = c.withResumeToken(o.resumeToken, r)), 
                i = i.insert(a, c), 
     ...
     */
                ...
                }(u, c, o) && s.push(n.hs.updateTargetData(t, c));
            }
        }));
        var a = qn();
        ...
        s.push(Xo(t, o, e.documentUpdates).next((function(t) {
            a = t;
        }))), !r.isEqual(dt.min())) {
            var u = n.hs.getLastRemoteSnapshotVersion(t).next((function(e) {
                return n.hs.setTargetsMetadata(t, t.currentSequenceNumber, r);
            }));
            s.push(u);
        }
        return si.waitFor(s).next((function() {
            return o.apply(t);
        })).next((function() {
            return n.ui.Ks(t, a);
        })).next((function() {
 ...
 */ function Xo(t, e, n) {
    ...
    return n.forEach((function(t) {
        ...
        return n.forEach((function(n, i) {
            ...
            r = r.insert(n, i)) : q("LocalStore", "Ignoring outdated watch update for ", n, ". Current version:", o.version, " Watch version:", i.version);
        })), r;
    }))
    /**
...
function Jo(t, e) {
    ...
    return n.persistence.runTransaction("Get next mutation batch", "readonly", (function(t) {
        return void 0 === e && (e = -1), n.Fs.getNextMutationBatchAfterBatchId(t, e);
    }));
}
 ...
 */ function $o(t, e) {
    ...
    return n.persistence.runTransaction("Allocate target", "readwrite", (function(t) {
        var r;
        return n.hs.getTargetData(t, e).next((function(i) {
            return i ? (
            // This target has been listened to previously, so reuse the
            // previous targetID.
            // TODO(mcg): freshen last accessed date?
            r = i, si.resolve(r)) : n.hs.allocateTargetId(t).next((function(i) {
                return r = new Ii(e, i, 0 /* Listen */ , t.currentSequenceNumber), n.hs.addTargetData(t, r).next((function() {
                    return r;
                }));
            }));
        }));
 ...
 */ function ts(t, e, n) {
    var r = W(t), i = dt.min(), o = Qn();
    return r.persistence.runTransaction("Execute query", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = r.ii.get(n);
            return void 0 !== i ? si.resolve(r.si.get(i)) : r.hs.getTargetData(e, n);
        }(r, t, qe(e)).next((function(e) {
            if (e) return i = e.lastLimboFreeSnapshotVersion, r.hs.getMatchingKeysForTargetId(t, e.targetId).next((function(t) {
                o = t;
            }));
        })).next((function() {
            return r.ni.Gs(t, e, n ? i : dt.min(), n ? o : Qn());
        })).next((function(t) {
            return {
                documents: t,
                hi: o
...
// PORTING NOTE: Multi-Tab only.
function es(t, e) {
    var n = W(t), r = W(n.hs), i = n.si.get(e);
...
function ns(t) {
    ...
    return e.persistence.runTransaction("Get new document changes", "readonly", (function(t) {
        return function(t, e, n) {
            var r = W(t), i = qn(), o = _i(n), s = xo(e), a = IDBKeyRange.lowerBound(o, !0);
            return s.Wt({
                index: "readTimeIndex",
                range: a
            }, (function(t, e) {
            ...
            return [ 2 /*return*/ , (e = W(t)).persistence.runTransaction("Synchronize last document change read time", "readonly", (function(t) {
                return function(t) {
                    ...
                    // If there are no existing entries, we return SnapshotVersion.min().
                        ...
                        e.readTime && (n = Ni(e.readTime)), r.done();
                    })).next((function() {
                        return n;
                    }));
                }(t);
 ...
 */ function is(t, e, i, o) {
    return n(this, void 0, void 0, (function() {
        var n, s, a, u, c, h, l, f, d, p;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                for (n = W(t), s = Qn(), a = qn(), u = 0, c = i; u < c.length; u++) h = c[u], l = e.li(h.metadata.name), 
                h.document && (s = s.add(l)), (f = e.fi(h)).setReadTime(e.di(h.metadata.readTime)), 
                a = a.insert(l, f);
                return d = n.oi.newChangeBuffer({
                    trackRemovals: !0
                }), [ 4 /*yield*/ , $o(n, function(t) {
                    // It is OK that the path used for the query is not valid, because this will
                    // not be read and queried.
                    return qe(Re(gt.fromString("__bundle__/docs/" + t)));
                }(o)) ];
              ...
              case 1:
                ...
                return p = r.sent(), [ 2 /*return*/ , n.persistence.runTransaction("Apply bundle documents", "readwrite", (function(t) {
                    return Xo(t, d, a).next((function(e) {
                        return d.apply(t), e;
                    })).next((function(e) {
                        return n.hs.removeMatchingKeysForTargetId(t, p.targetId).next((function() {
                            return n.hs.addMatchingKeys(t, s, p.targetId);
                        })).next((function() {
                            return n.ui.Ks(t, e);
                        })).next((function() {
                            return e;
 ...
 */ function os(t, e, i) {
    return void 0 === i && (i = Qn()), n(this, void 0, void 0, (function() {
        var n, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , $o(t, qe(Mi(e.bundledQuery))) ];
              ...
              case 1:
                return n = r.sent(), [ 2 /*return*/ , (o = W(t)).persistence.runTransaction("Save named query", "readwrite", (function(t) {
                    ...
                    // has.
                                        if (n.snapshotVersion.compareTo(r) >= 0) return o.fs.saveNamedQuery(t, e);
                    // Update existing target data because the query from the bundle is newer.
                                        var s = n.withResumeToken(Tt.EMPTY_BYTE_STRING, r);
                    return o.si = o.si.insert(s.targetId, s), o.hs.updateTargetData(t, s).next((function() {
                        return o.hs.removeMatchingKeysForTargetId(t, n.targetId);
                    })).next((function() {
                        return o.hs.addMatchingKeys(t, i, n.targetId);
                    })).next((function() {
                        return o.fs.saveNamedQuery(t, e);
                    }));
                })) ];
            }
        }));
 ...
 */ var ss = /** @class */ function() {
    ...
    return t.prototype.getBundleMetadata = function(t, e) {
        return si.resolve(this._i.get(e));
    }, t.prototype.saveBundleMetadata = function(t, e) {
        ...
        return si.resolve(this.wi.get(e));
    }, t.prototype.saveNamedQuery = function(t, e) {
    ...
    function t() {
        ...
        this.overlays = new Rn(Ot.comparator), this.mi = new Map;
    }
    return t.prototype.getOverlay = function(t, e) {
        ...
        })), this.mi.delete(n)), si.resolve();
    }, t.prototype.getOverlaysForCollection = function(t, e, n) {
        for (var r = jn(), i = e.length + 1, o = new Ot(e.child("")), s = this.overlays.getIteratorFrom(o); s.hasNext(); ) {
            var a = s.getNext().value, u = a.getKey();
            if (!e.isPrefixOf(u.path)) break;
            // Documents from sub-collections
                        u.path.length === i && a.largestBatchId > n && r.set(a.getKey(), a);
        }
        return si.resolve(r);
    }, t.prototype.getOverlaysForCollectionGroup = function(t, e, n, r) {
        for (var i = new Rn((function(t, e) {
            return t - e;
        })), o = this.overlays.getIterator(); o.hasNext(); ) {
            var s = o.getNext().value;
            if (s.getKey().getCollectionGroup() === e && s.largestBatchId > n) {
                var a = i.get(s.largestBatchId);
                null === a && (a = jn(), i = i.insert(s.largestBatchId, a)), a.set(s.getKey(), s);
            }
        }
        for (var u = jn(), c = i.getIterator(); c.hasNext() && (c.getNext().value.forEach((function(t, e) {
            return u.set(t, e);
        })), !(u.size() >= r)); ) ;
        return si.resolve(u);
        ...
        if (null !== n) {
            ...
            var o = this.mi.get(e);
            void 0 === o && (o = Qn(), this.mi.set(e, o)), this.mi.set(e, o.add(n.key));
        }
    }, t;
}(), us = /** @class */ function() {
    function t() {
        // A set of outstanding references to a document sorted by key.
        this.gi = new On(cs.yi), 
        // A set of outstanding references to a document sorted by target id.
        this.pi = new On(cs.Ii)
    ...
    t.prototype.Ri = function(t) {
        var e = this, n = new Ot(new gt([])), r = new cs(n, t), i = new cs(n, t + 1), o = [];
        ...
        var e = new Ot(new gt([])), n = new cs(e, t), r = new cs(e, t + 1), i = Qn();
        return this.pi.forEachInRange([ n, r ], (function(t) {
            i = i.add(t.key);
        })), i;
    }, t.prototype.containsKey = function(t) {
        var e = new cs(t, 0), n = this.gi.firstAfterOrEqual(e);
    ...
    return t.yi = function(t, e) {
        return Ot.comparator(t.key, e.key) || ct(t.Vi, e.Vi);
    }, 
    /** Compare by ID then by key */ t.Ii = function(t, e) {
        return ct(t.Vi, e.Vi) || Ot.comparator(t.key, e.key);
    }, t;
}(), hs = /** @class */ function() {
    function t(t, e) {
        ...
        this.Si = new On(cs.yi);
    }
    return t.prototype.checkEmpty = function(t) {
        return si.resolve(0 === this.Fs.length);
    }, t.prototype.addMutationBatch = function(t, e, n, r) {
        var i = this.vi;
        this.vi++, this.Fs.length > 0 && this.Fs[this.Fs.length - 1];
        var o = new gi(i, e, n, r);
        this.Fs.push(o);
        // Track references by document key and index collection parents.
        for (var s = 0, a = r; s < a.length; s++) {
            var u = a[s];
            this.Si = this.Si.add(new cs(u.key, i)), this.indexManager.addToCollectionParentIndex(t, u.key.path.popLast());
        }
        return si.resolve(o);
    }, t.prototype.lookupMutationBatch = function(t, e) {
        return si.resolve(this.Di(e));
    }, t.prototype.getNextMutationBatchAfterBatchId = function(t, e) {
        var n = e + 1, r = this.Ci(n), i = r < 0 ? 0 : r;
        // The requested batchId may still be out of range so normalize it to the
        // start of the queue.
                return si.resolve(this.Fs.length > i ? this.Fs[i] : null);
    }, t.prototype.getHighestUnacknowledgedBatchId = function() {
        return si.resolve(0 === this.Fs.length ? -1 : this.vi - 1);
    }, t.prototype.getAllMutationBatches = function(t) {
        return si.resolve(this.Fs.slice());
    }, t.prototype.getAllMutationBatchesAffectingDocumentKey = function(t, e) {
        ...
        var o = new cs(new Ot(i), 0), s = new On(ct);
        ...
        var n = this;
        z(0 === this.Ni(e.batchId, "removed")), this.Fs.shift();
        var r = this.Si;
        return si.forEach(e.mutations, (function(i) {
        ...
        var n = new cs(e, 0), r = this.Si.firstAfterOrEqual(n);
        return si.resolve(e.isEqual(r && r.key));
    }, t.prototype.performConsistencyCheck = function(t) {
        return this.Fs.length, si.resolve();
    }, 
    /**
    ...
    t.prototype.Ci = function(t) {
        return 0 === this.Fs.length ? 0 : t - this.Fs[0].batchId;
    ...
    t.prototype.Di = function(t) {
        var e = this.Ci(t);
        return e < 0 || e >= this.Fs.length ? null : this.Fs[e];
    }, t;
}(), ls = /** @class */ function() {
    /**
    ...
    function t(t) {
        ...
        this.docs = new Rn(Ot.comparator), 
    ...
    t.prototype.removeEntry = function(t) {
        ...
        return si.resolve(n ? n.document.mutableCopy() : ie.newInvalidDocument(e));
    }, t.prototype.getEntries = function(t, e) {
        var n = this, r = qn();
        return e.forEach((function(t) {
            var e = n.docs.get(t);
        ...
        for (var r = qn(), i = new Ot(e.child("")), o = this.docs.getIteratorFrom(i)
        // Documents are ordered by key, so we can use a prefix scan to narrow down
        // the documents we need to match the query against.
        ; o.hasNext(); ) {
            var s = o.getNext(), a = s.key, u = s.value.document;
            if (!e.isPrefixOf(a.path)) break;
            a.path.length > e.length + 1 || u.readTime.compareTo(n) <= 0 || (r = r.insert(u.key, u.mutableCopy()));
        }
        return si.resolve(r);
    ...
    function n(t) {
        var n = this;
        return (n = e.call(this) || this).Un = t, n;
    }
    return t(n, e), n.prototype.applyChanges = function(t) {
        var e = this, n = [];
        return this.changes.forEach((function(r, i) {
            i.isValidDocument() ? n.push(e.Un.addEntry(t, i)) : e.Un.removeEntry(r);
        })), si.waitFor(n);
    }, n.prototype.getFromCache = function(t, e) {
...
}(Do), ds = /** @class */ function() {
    function t(t) {
        this.persistence = t, 
        /**
             * Maps a target to the data about that target
             */
        this.Oi = new Mn((function(t) {
            return de(t);
        }), pe), 
        ...
        /**
             ...
             * IDs.
             */
        this.Fi = new us, this.targetCount = 0, this.Bi = vo.mn();
    }
    return t.prototype.forEachTarget = function(t, e) {
        ...
        return si.resolve(this.$i);
    }, t.prototype.allocateTargetId = function(t) {
        return this.highestTargetId = this.Bi.next(), si.resolve(this.highestTargetId);
    }, t.prototype.setTargetsMetadata = function(t, e, n) {
        ...
        var e = t.targetId;
        e > this.highestTargetId && (this.Bi = new vo(e), this.highestTargetId = e), t.sequenceNumber > this.$i && (this.$i = t.sequenceNumber);
    }, t.prototype.addTargetData = function(t, e) {
        return this.In(e), this.targetCount += 1, si.resolve();
    }, t.prototype.updateTargetData = function(t, e) {
        return this.In(e), si.resolve();
    }, t.prototype.removeTargetData = function(t, e) {
        return this.Oi.delete(e.target), this.Fi.Ri(e.targetId), this.targetCount -= 1, 
        si.resolve();
    }, t.prototype.removeTargets = function(t, e, n) {
        var r = this, i = 0, o = [];
        return this.Oi.forEach((function(s, a) {
            a.sequenceNumber <= e && null === n.get(a.targetId) && (r.Oi.delete(s), o.push(r.removeMatchingKeysForTargetId(t, a.targetId)), 
            i++);
        })), si.waitFor(o).next((function() {
            return i;
        }));
    }, t.prototype.getTargetCount = function(t) {
        ...
        return this.Fi.Ti(e, n), si.resolve();
    }, t.prototype.removeMatchingKeys = function(t, e, n) {
        this.Fi.Ai(e, n);
        ...
        return this.Fi.Ri(e), si.resolve();
    }, t.prototype.getMatchingKeysForTargetId = function(t, e) {
        var n = this.Fi.Pi(e);
        return si.resolve(n);
    }, t.prototype.containsKey = function(t, e) {
        return si.resolve(this.Fi.containsKey(e));
    }, t;
}(), ps = /** @class */ function() {
    /**
    ...
    function t(t, e) {
        var n = this;
        this.Li = {}, this.overlays = {}, this.Zn = new st(0), this.ts = !1, this.ts = !0, 
        this.referenceDelegate = t(this), this.hs = new ds(this), this.indexManager = new Ji, 
        this.ls = new ls((function(t) {
            return n.referenceDelegate.qi(t);
        })), this.M = new Ei(e), this.fs = new ss(this.M);
    }
    return t.prototype.start = function() {
        return Promise.resolve();
    }, t.prototype.shutdown = function() {
        ...
        return e || (e = new as, this.overlays[t.toKey()] = e), e;
    }, t.prototype.getMutationQueue = function(t, e) {
        var n = this.Li[t.toKey()];
        return n || (n = new hs(e, this.referenceDelegate), this.Li[t.toKey()] = n), n;
    }, t.prototype.getTargetCache = function() {
        return this.hs;
    }, t.prototype.getRemoteDocumentCache = function() {
        return this.ls;
        ...
        var i = new vs(this.Zn.next());
        return this.referenceDelegate.Ui(), n(i).next((function(t) {
            return r.referenceDelegate.Ki(i).next((function() {
                return t;
            }));
        ...
        return si.or(Object.values(this.Li).map((function(n) {
            return function() {
    ...
    return t.Wi = function(e) {
        ...
        return this.Qi.addReference(n, e), this.zi.delete(n.toString()), si.resolve();
    }, t.prototype.removeReference = function(t, e, n) {
        return this.Qi.removeReference(n, e), this.zi.add(n.toString()), si.resolve();
    }, t.prototype.markPotentiallyOrphaned = function(t, e) {
        return this.zi.add(e.toString()), si.resolve();
    }, t.prototype.removeTarget = function(t, e) {
        var n = this;
        ...
        // Remove newly orphaned documents.
                return si.forEach(this.zi, (function(r) {
            var i = Ot.fromPath(r);
        ...
        var n = this;
        return si.or([ function() {
            return si.resolve(n.Qi.containsKey(e));
        }, function() {
            return n.persistence.getTargetCache().containsKey(t, e);
        }, function() {
            return n.persistence.Gi(t, e);
        } ]);
    }, t;
}();
...
// contain.
/** Assembles the key for a mutation batch in WebStorage */ function gs(t, e, n) {
...
/** Assembles the key for a query state in WebStorage */ function ws(t, e) {
...
var bs = /** @class */ function() {
    ...
    return t.Ji = function(e, n) {
        for (var r = JSON.parse(n), i = "object" == typeof r && r.activeTargetIds instanceof Array, o = Hn(), s = 0; i && s < r.activeTargetIds.length; ++s) i = Lt(r.activeTargetIds[s]), 
    ...
    function t(t, e, n, r, i) {
        this.window = t, this.Hn = e, this.persistenceKey = n, this.tr = r, this.syncEngine = null, 
        this.onlineStateHandler = null, this.sequenceNumberHandler = null, this.er = this.nr.bind(this), 
        this.sr = new Rn(ct), this.started = !1, 
        /**
        ...
        var o = n.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
        this.storage = this.window.localStorage, this.currentUser = i, this.rr = ms(this.persistenceKey, this.tr), 
        this.ar = 
        /** Assembles the key for the current sequence number. */
        function(t) {
            return "firestore_sequence_number_" + t;
        }(this.persistenceKey), this.sr = this.sr.insert(this.tr, new Ss), this.ur = new RegExp("^firestore_clients_" + o + "_([^_]*)$"), 
    ...
    /** Returns 'true' if WebStorage is available in the current environment. */    return t.vt = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            var t, e, n, i, o, s, a, u, c, h, l, f = this;
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.syncEngine.Ms() ];

                  case 1:
                    for (t = r.sent(), e = 0, n = t; e < n.length; e++) (i = n[e]) !== this.tr && (o = this.getItem(ms(this.persistenceKey, i))) && (s = Es.Ji(i, o)) && (this.sr = this.sr.insert(s.clientId, s));
                    for (this._r(), (a = this.storage.getItem(this.lr)) && (u = this.wr(a)) && this.mr(u), 
                    c = 0, h = this.ir; c < h.length; c++) l = h[c], this.nr(l);
                    return this.ir = [], 
        ...
        // by another tab
            ...
            var n = this.storage.getItem(ws(this.persistenceKey, t));
            if (n) {
                var r = Is.Ji(t, n);
                r && (e = r.state);
            }
        ...
        this.removeItem(ws(this.persistenceKey, t));
        ...
        // `Window.addEventListener`.
            ...
            if (q("SharedClientState", "EVENT", i.key, i.newValue), i.key === this.rr) return void B("Received WebStorage notification for local change. Another client might have garbage-collected our state");
            this.Hn.enqueueRetryable((function() {
                return n(e, void 0, void 0, (function() {
                    var t, e, n, o, s, a;
                    return r(this, (function(r) {
                        if (this.started) {
                            if (null !== i.key) if (this.ur.test(i.key)) {
                                if (null == i.newValue) return t = this.Rr(i.key), [ 2 /*return*/ , this.br(t, null) ];
                                if (e = this.Pr(i.key, i.newValue)) return [ 2 /*return*/ , this.br(e.clientId, e) ];
                            } else if (this.cr.test(i.key)) {
                                if (null !== i.newValue && (n = this.Vr(i.key, i.newValue))) return [ 2 /*return*/ , this.vr(n) ];
                            } else if (this.hr.test(i.key)) {
                                if (null !== i.newValue && (o = this.Sr(i.key, i.newValue))) return [ 2 /*return*/ , this.Dr(o) ];
                            } else if (i.key === this.lr) {
                                if (null !== i.newValue && (s = this.wr(i.newValue))) return [ 2 /*return*/ , this.mr(s) ];
                            } else if (i.key === this.ar) a = function(t) {
                                var e = st.A;
                                if (null != t) try {
                                    var n = JSON.parse(t);
                                ...
                                return e;
                            }(i.newValue), a !== st.A && this.sequenceNumberHandler(a); else if (i.key === this.dr) return [ 2 /*return*/ , this.syncEngine.Cr() ];
                        } else this.ir.push(i);
                        return [ 2 /*return*/ ];
                    }));
                }));
        ...
        var r = new bs(this.currentUser, t, e, n), i = gs(this.persistenceKey, this.currentUser, t);
        this.setItem(i, r.Yi());
    }, t.prototype.pr = function(t) {
        var e = gs(this.persistenceKey, this.currentUser, t);
        this.removeItem(e);
        ...
        var r = ws(this.persistenceKey, t), i = new Is(t, e, n);
        this.setItem(r, i.Yi());
    ...
    t.prototype.wr = function(t) {
        ...
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                return t.user.uid === this.currentUser.uid ? [ 2 /*return*/ , this.syncEngine.Nr(t.batchId, t.state, t.error) ] : (q("SharedClientState", "Ignoring mutation for non-active user " + t.user.uid), 
                [ 2 /*return*/ ]);
            }));
        }));
        ...
        var n = this, r = e ? this.sr.insert(t, e) : this.sr.remove(t), i = this.gr(this.sr), o = this.gr(r), s = [], a = [];
        return o.forEach((function(t) {
            i.has(t) || s.push(t);
        })), i.forEach((function(t) {
            o.has(t) || a.push(t);
        })), this.syncEngine.Mr(s, a).then((function() {
            n.sr = r;
        }));
    ...
    function t() {
        this.Or = new Ss, this.$r = {}, this.onlineStateHandler = null, this.sequenceNumberHandler = null;
    }
    return t.prototype.addPendingMutation = function(t) {
        ...
        return this.Or = new Ss, Promise.resolve();
    }, t.prototype.handleUserChange = function(t, e, n) {
        // No op.
    }, t.prototype.setOnlineState = function(t) {
        // No op.
    ...
    return t.prototype.Wr = function(t) {
        this.zr = t;
    ...
    return t(n, e), n.prototype.ao = function(t, e, n, r) {
            ...
            s.listenOnce(N.COMPLETE, (function() {
                try {
                    switch (s.getLastErrorCode()) {
                      ...
                      case D.TIMEOUT:
                        q("Connection", 'RPC "' + t + '" timed out'), o(new Y(H.DEADLINE_EXCEEDED, "Request time out"));
                        break;
    ...
    }, n.prototype.co = function(t, e, n) {
        var r = [ this.no, "/", "google.firestore.v1.Firestore", "/", t, "/channel" ], i = A(), o = C(), s = {
        ...
        this.useFetchStreams && (s.xmlHttpFactory = new k({})), this.oo(s.initMessageHeaders, e, n), 
        ...
        v() || y() || m() || g() || w() || b() || (s.httpHeadersOverwriteParam = "$httpHeaders");
        var a = r.join("");
        q("Connection", "Creating WebChannel: " + a, s);
        var u = i.createWebChannel(a, s), c = !1, h = !1, l = new ks({
            Qr: function(t) {
        ...
        return f(u, x.EventType.OPEN, (function() {
            h || q("Connection", "WebChannel transport opened.");
        })), f(u, x.EventType.CLOSE, (function() {
            h || (h = !0, q("Connection", "WebChannel transport closed"), l.Zr());
        })), f(u, x.EventType.ERROR, (function(t) {
            h || (h = !0, K("Connection", "WebChannel transport errored:", t), l.Zr(new Y(H.UNAVAILABLE, "The operation could not be completed")));
        })), f(u, x.EventType.MESSAGE, (function(t) {
            var e;
            if (!h) {
                var n = t.data[0];
                z(!!n);
 ...
 */
                    function(t) {
                        ...
                        // eslint-disable-next-line @typescript-eslint/no-explicit-any
                        var e = _n[t];
                        if (void 0 !== e) return xn(e);
                    }(o), a = i.message;
                    void 0 === s && (s = H.INTERNAL, a = "Unknown error status: " + o + " with message " + i.message), 
                    // Mark closed so no further events are propagated
                    h = !0, l.Zr(new Y(s, a)), u.close();
                } else q("Connection", "WebChannel received:", n), l.eo(n);
            }
    ...
    return t.prototype.io = function(t, e, n, r, i) {
        var o = this.ro(t, e);
        q("RestConnection", "Sending: ", o, n);
        var s = {};
        return this.oo(s, r, i), this.ao(t, o, s, n).then((function(t) {
            return q("RestConnection", "Received: ", t), t;
        }), (function(e) {
            throw K("RestConnection", t + " failed with error: ", e, "url: ", o, "request:", n), 
            e;
        }));
    }, t.prototype.uo = function(t, e, n, r, i) {
 ...
 * limitations under the License.
 */ function Vs(t) {
    return new sr(t, /* useProto3Json= */ !0);
}
 ...
 */ var Ls = /** @class */ function() {
     ...
     */ , i) {
        ...
        this.Hn = t, this.timerId = e, this.ho = n, this.lo = r, this.fo = i, this._o = 0, 
        this.wo = null, 
    ...
    t.prototype.po = function(t) {
        ...
        // honored as such).
        var n = Math.floor(this._o + this.Io()), r = Math.max(0, Date.now() - this.mo), i = Math.max(0, n - r);
        // Guard against lastAttemptTime being in the future due to a clock change.
                i > 0 && q("ExponentialBackoff", "Backing off for " + i + " ms (base delay: " + this._o + " ms, delay with jitter: " + n + " ms, last attempt: " + r + " ms ago)"), 
        this.wo = this.Hn.enqueueAfterDelay(this.timerId, i, (function() {
            return e.mo = Date.now(), t();
        })), 
    ...
    /** Returns a random value in the range [-currentBaseMs/2, currentBaseMs/2] */ t.prototype.Io = function() {
        return (Math.random() - .5) * this._o;
    }, t;
}(), Os = /** @class */ function() {
    function t(t, e, n, r, i, o, s, a) {
        this.Hn = t, this.Eo = n, this.Ao = r, this.Ro = i, this.authCredentialsProvider = o, 
        ...
        /**
             ...
             * close.
             */
        this.bo = 0, this.Po = null, this.Vo = null, this.stream = null, this.vo = new Ls(t, e)
        /**
    ...
    t.prototype.stop = function() {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(t) {
                switch (t.label) {
                  case 0:
                    return this.So() ? [ 4 /*yield*/ , this.close(0 /* Initial */) ] : [ 3 /*break*/ , 2 ];
    ...
    t.prototype.No = function() {
        ...
        // running a timer (in which case the previous idle timeout still applies).
                this.Do() && null === this.Po && (this.Po = this.Hn.enqueueAfterDelay(this.Eo, 6e4, (function() {
            return t.ko();
        })));
    }, 
    ...
    /** Called by the idle timer when the stream should close due to inactivity. */ t.prototype.ko = function() {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(t) {
                return this.Do() ? [ 2 /*return*/ , this.close(0 /* Initial */) ] : [ 2 /*return*/ ];
            }));
        }));
    }, 
    /** Marks the stream as active again. */ t.prototype.Oo = function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    ...
                    return this.Oo(), this.$o(), this.vo.cancel(), 
                    // Invalidates any stream-related callbacks (e.g. from auth or the
                    // underlying stream), guaranteeing they won't execute.
                    this.bo++, 4 /* Error */ !== t ? 
                    // If this is an intentional close ensure we don't delay our next connection attempt.
                    this.vo.reset() : e && e.code === H.RESOURCE_EXHAUSTED ? (
                    // Log the error. (Probably either 'quota exceeded' or 'max queue length reached'.)
                    B(e.toString()), B("Using maximum backoff delay to prevent overloading the backend."), 
                    this.vo.yo()) : e && e.code === H.UNAUTHENTICATED && 3 /* Healthy */ !== this.state && (
                    ...
                    this.state = t, [ 4 /*yield*/ , this.listener.Hr(e) ];
    ...
    t.prototype.Fo = function() {}, t.prototype.auth = function() {
        ...
        var e = this.Bo(this.bo), n = this.bo;
        ...
        var n = this, r = this.Bo(this.bo);
        this.stream = this.Uo(t, e), this.stream.Wr((function() {
            r((function() {
                return n.state = 2 /* Open */ , n.Vo = n.Hn.enqueueAfterDelay(n.Ao, 1e4, (function() {
                    return n.Do() && (n.state = 3 /* Healthy */), Promise.resolve();
                })), n.listener.Wr();
            }));
        })), this.stream.Hr((function(t) {
            r((function() {
                return n.qo(t);
            }));
        ...
        var t = this;
        this.state = 5 /* Backoff */ , this.vo.po((function() {
    ...
    t.prototype.Bo = function(t) {
        var e = this;
        return function(n) {
            e.Hn.enqueueAndForget((function() {
                return e.bo === t ? n() : (q("PersistentStream", "stream callback skipped by getCloseGuardedDispatcher."), 
                Promise.resolve());
            }));
        };
    }, t;
    ...
    function n(t, n, r, i, o, s) {
        var a = this;
        return (a = e.call(this, t, "listen_stream_connection_backoff" /* ListenStreamConnectionBackoff */ , "listen_stream_idle" /* ListenStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).M = o, 
        a;
    }
    return t(n, e), n.prototype.Uo = function(t, e) {
        ...
        var e = function(t, e) {
            ...
            if ("targetChange" in e) {
                ...
                var r = function(t) {
                    ...
                    var e = void 0 === t.code ? H.UNKNOWN : xn(t.code);
                    return new Y(e, t.message || "");
                }(s);
                n = new Zn(r, i, o, a || null);
            } else if ("documentChange" in e) {
                e.documentChange;
                var u = e.documentChange;
                u.document, u.document.name, u.document.updateTime;
                var c = pr(t, u.document.name), h = hr(u.document.updateTime), l = new ne({
                    mapValue: {
                        fields: u.document.fields
                    }
                }), f = ie.newFoundDocument(c, h, l), d = u.targetIds || [], p = u.removedTargetIds || [];
                n = new Jn(d, p, f.key, f);
            } else if ("documentDelete" in e) {
                e.documentDelete;
                var v = e.documentDelete;
                v.document;
                var y = pr(t, v.document), m = v.readTime ? hr(v.readTime) : dt.min(), g = ie.newNoDocument(y, m), w = v.removedTargetIds || [];
                n = new Jn([], w, g.key, g);
                ...
                var T = e.filter;
                T.targetId;
                var S = T.count || 0, _ = new Cn(S), N = T.targetId;
                n = new $n(N, _);
            }
            return n;
            ...
            return e.targetIds && e.targetIds.length ? dt.min() : e.readTime ? hr(e.readTime) : dt.min();
        }(t);
    ...
    n.prototype.Go = function(t) {
        var e = {};
        e.database = mr(this.M), e.addTarget = function(t, e) {
            var n, r = e.target;
            return (n = ve(r) ? {
                documents: Tr(t, r)
            } : {
                query: Sr(t, r)
            }).targetId = e.targetId, e.resumeToken.approximateByteSize() > 0 ? n.resumeToken = ur(t, e.resumeToken) : e.snapshotVersion.compareTo(dt.min()) > 0 && (
    ...
    n.prototype.Qo = function(t) {
        var e = {};
        e.database = mr(this.M), e.removeTarget = t, this.Mo(e);
    }, n;
}(Os), Ps = /** @class */ function(e) {
    function n(t, n, r, i, o, s) {
        var a = this;
        return (a = e.call(this, t, "write_stream_connection_backoff" /* WriteStreamConnectionBackoff */ , "write_stream_idle" /* WriteStreamIdle */ , "health_check_timeout" /* HealthCheckTimeout */ , n, r, i, s) || this).M = o, 
        a.jo = !1, a;
    }
    ...
    n.prototype.start = function() {
        ...
        this.jo && this.zo([]);
    }, n.prototype.Uo = function(t, e) {
        return this.Ro.co("Write", t, e);
    }, n.prototype.onMessage = function(t) {
        if (
        // Always capture the last stream token.
        z(!!t.streamToken), this.lastStreamToken = t.streamToken, this.jo) {
            ...
            var e = function(t, e) {
                return t && t.length > 0 ? (z(void 0 !== e), t.map((function(t) {
                    return function(t, e) {
                        ...
                        n = hr(e)), new ln(n, t.transformResults || []);
                    }(t, e);
                }))) : [];
        ...
        // The first response is always the handshake response
                return z(!t.writeResults || 0 === t.writeResults.length), this.jo = !0, 
        this.listener.Jo();
    }, 
    /**
    ...
    n.prototype.Yo = function() {
        ...
        var t = {};
        t.database = mr(this.M), this.Mo(t);
    }, 
...
}(Os), Us = /** @class */ function(e) {
    function n(t, n, r, i) {
        var o = this;
        return (o = e.call(this) || this).authCredentials = t, o.appCheckCredentials = n, 
        o.Ro = r, o.M = i, o.Xo = !1, o;
    }
    return t(n, e), n.prototype.Zo = function() {
        if (this.Xo) throw new Y(H.FAILED_PRECONDITION, "The client has already been terminated.");
    }, 
    /** Invokes the provided RPC with auth and AppCheck tokens. */ n.prototype.io = function(t, e, n) {
        var r = this;
        return this.Zo(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], s = i[1];
            return r.Ro.io(t, e, n, o, s);
        })).catch((function(t) {
    ...
    /** Invokes the provided RPC with streamed results with auth and AppCheck tokens. */ n.prototype.uo = function(t, e, n) {
        var r = this;
        return this.Zo(), Promise.all([ this.authCredentials.getToken(), this.appCheckCredentials.getToken() ]).then((function(i) {
            var o = i[0], s = i[1];
            return r.Ro.uo(t, e, n, o, s);
        })).catch((function(t) {
            throw "FirebaseError" === t.name ? (t.code === H.UNAUTHENTICATED && (r.authCredentials.invalidateToken(), 
            r.appCheckCredentials.invalidateToken()), t) : new Y(H.UNKNOWN, t.toString());
        }));
    ...
    return t.prototype.sa = function() {
        var t = this;
        0 === this.ta && (this.ia("Unknown" /* Unknown */), this.ea = this.asyncQueue.enqueueAfterDelay("online_state_timeout" /* OnlineStateTimeout */ , 1e4, (function() {
            return t.ea = null, t.ra("Backend didn't respond within 10 seconds."), t.ia("Offline" /* Offline */), 
            Promise.resolve();
        })));
    }, 
    /**
    ...
    t.prototype.set = function(t) {
        ...
        this.na ? (B(e), this.na = !1) : q("OnlineStateTracker", e);
...
e, i, o, s) {
    ...
    /**
             ...
             */
    this.la = [], this.fa = s, this.fa.Fr((function(t) {
        i.enqueueAndForget((function() {
            return n(a, void 0, void 0, (function() {
                return r(this, (function(t) {
                    switch (t.label) {
                      case 0:
                        return Xs(this) ? (q("RemoteStore", "Restarting streams for network reachability change."), 
                        [ 4 /*yield*/ , function(t) {
                            return n(this, void 0, void 0, (function() {
                                var e;
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).ha.add(4 /* ConnectivityChange */), [ 4 /*yield*/ , js(e) ];

                                      case 1:
                                        return n.sent(), e.da.set("Unknown" /* Unknown */), e.ha.delete(4 /* ConnectivityChange */), 
                                        [ 4 /*yield*/ , Ks(e) ];
 ...
 */ function Ks(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (!Xs(t)) return [ 3 /*break*/ , 4 ];
                e = 0, n = t.la, r.label = 1;
 ...
 */ function zs(t, e) {
    var n = W(t), r = fa(n);
    n.ca.delete(e), r.Do() && Ws(n, e), 0 === n.ca.size && (r.Do() ? r.No() : Xs(n) && 
...
function Ys(t) {
    return Xs(t) && !fa(t).So() && t.ca.size > 0;
}

function Xs(t) {
    return 0 === W(t).ha.size;
}
...
function $s(t) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(e) {
            return t.ca.forEach((function(e, n) {
                Qs(t, e);
            })), [ 2 /*return*/ ];
        }));
    }));
...
function Zs(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(n) {
            ...
            t.da.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
        }));
    }));
}
...
function ta(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(u) {
            switch (u.label) {
              case 0:
                if (t.da.set("Online" /* Online */), !(e instanceof Zn && 2 /* Removed */ === e.state && e.cause)) 
                    ...
                    return n(this, void 0, void 0, (function() {
                        ...
                        return r(this, (function(r) {
                            switch (r.label) {
                              ...
                              case 1:
                                return i < o.length ? (s = o[i], t.ca.has(s) ? [ 4 /*yield*/ , t.remoteSyncer.rejectListen(s, n) ] : [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 5 ];

                              case 2:
                                r.sent(), t.ca.delete(s), t._a.removeTarget(s), r.label = 3;
              ...
              case 6:
                if (e instanceof Jn ? t._a.at(e) : e instanceof $n ? t._a._t(e) : t._a.ht(e), i.isEqual(dt.min())) return [ 3 /*break*/ , 13 ];
                u.label = 7;

              case 7:
                return u.trys.push([ 7, 11, , 13 ]), [ 4 /*yield*/ , Ho(t.localStore) ];
                ...
                function(t, e) {
                    ...
                    // persistent view of these when applying the completed RemoteEvent.
                        ...
                        if (n.resumeToken.approximateByteSize() > 0) {
                            ...
                            // A watched target might have been removed already.
                                                        i && t.ca.set(r, i.withResumeToken(n.resumeToken, e));
                        }
                    })), 
                    ...
                    n.targetMismatches.forEach((function(e) {
                        ...
                        if (n) {
                            ...
                            // state.
                            t.ca.set(e, n.withResumeToken(Tt.EMPTY_BYTE_STRING, n.snapshotVersion)), 
              ...
              case 11:
                return q("RemoteStore", "Failed to raise snapshot:", a = u.sent()), [ 4 /*yield*/ , ea(t, a) ];
        ...
        return r(this, (function(s) {
            switch (s.label) {
              case 0:
                ...
                return t.ha.add(1 /* IndexedDbFailed */), [ 4 /*yield*/ , js(t) ];

              case 1:
                // Disable network and raise offline snapshots
                return s.sent(), t.da.set("Offline" /* Offline */), i || (
                // Use a simple read operation to determine if IndexedDB recovered.
                // Ideally, we would expose a health check directly on SimpleDb, but
                // RemoteStore only has access to persistence through LocalStore.
                i = function() {
                    return Ho(t.localStore);
                }), 
                    ...
                    return n(o, void 0, void 0, (function() {
                        return r(this, (function(e) {
                            switch (e.label) {
                              ...
                              case 1:
                                return e.sent(), t.ha.delete(1 /* IndexedDbFailed */), [ 4 /*yield*/ , Ks(t) ];
...
function ra(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                e = W(t), n = da(e), i = e.ua.length > 0 ? e.ua[e.ua.length - 1].batchId : -1, r.label = 1;
 ...
 */ (e)) return [ 3 /*break*/ , 7 ];
              ...
              case 2:
                return r.trys.push([ 2, 4, , 6 ]), [ 4 /*yield*/ , Jo(e.localStore, i) ];

              case 3:
                return null === (o = r.sent()) ? (0 === e.ua.length && n.No(), [ 3 /*break*/ , 7 ]) : (i = o.batchId, 
                function(t, e) {
                    t.ua.push(e);
                    var n = da(t);
              ...
              case 4:
                return s = r.sent(), [ 4 /*yield*/ , ea(e, s) ];
...
function ia(t) {
    return Xs(t) && !da(t).So() && t.ua.length > 0;
}
...
function aa(t) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            ...
            for (e = da(t), n = 0, i = t.ua; n < i.length; n++) o = i[n], e.zo(o.mutations);
            return [ 2 /*return*/ ];
        }));
    }));
}
...
function ua(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = t.ua.shift(), o = wi.from(n, e, i), [ 4 /*yield*/ , na(t, (function() {
...
function ca(t, e) {
    return n(this, void 0, void 0, (function() {
        return r(this, (function(i) {
            switch (i.label) {
              case 0:
                return e && da(t).Wo ? [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                return kn(i = e.code) && i !== H.ABORTED ? (n = t.ua.shift(), 
                                // In this case it's also unlikely that the server itself is melting
                                // down -- this was just a bad request so inhibit backoff on the next
                                // restart.
                                da(t).xo(), [ 4 /*yield*/ , na(t, (function() {
...
function ha(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = W(t)).asyncQueue.verifyOperationInProgress(), q("RemoteStore", "RemoteStore received new credentials"), 
                i = Xs(n), 
                // Tear down and re-create our network streams. This will ensure we get a
                // fresh auth token for the new user and re-fill the write pipeline with
                // new mutations from the LocalStore (since mutations are per-user).
                n.ha.add(3 /* CredentialChange */), [ 4 /*yield*/ , js(n) ];

              case 1:
                return r.sent(), i && 
                // Don't set the network status to Unknown if we are offline.
                n.da.set("Unknown" /* Unknown */), [ 4 /*yield*/ , n.remoteSyncer.handleCredentialChange(e) ];

              case 2:
                return r.sent(), n.ha.delete(3 /* CredentialChange */), [ 4 /*yield*/ , Ks(n) ];
 ...
 */ function la(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), e ? (n.ha.delete(2 /* IsSecondary */), [ 4 /*yield*/ , Ks(n) ]) : [ 3 /*break*/ , 2 ];

              case 1:
                return r.sent(), [ 3 /*break*/ , 5 ];

              case 2:
                return e ? [ 3 /*break*/ , 4 ] : (n.ha.add(2 /* IsSecondary */), [ 4 /*yield*/ , js(n) ]);

              case 3:
                r.sent(), n.da.set("Unknown" /* Unknown */), r.label = 4;
 ...
 */ function fa(t) {
    ...
    t.wa = function(t, e, n) {
        var r = W(t);
        return r.Zo(), new Fs(e, r.Ro, r.authCredentials, r.appCheckCredentials, r.M, n);
    }(t.datastore, t.asyncQueue, {
        Wr: $s.bind(null, t),
        Hr: Zs.bind(null, t),
        Ko: ta.bind(null, t)
    }), t.la.push((function(i) {
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.wa.xo(), Ys(t) ? Hs(t) : t.da.set("Unknown" /* Unknown */), [ 3 /*break*/ , 3 ]) : [ 3 /*break*/ , 1 ];

                  case 1:
                    return [ 4 /*yield*/ , t.wa.stop() ];

                  case 2:
                    e.sent(), Js(t), e.label = 3;
...
function da(t) {
    ...
    t.ma = function(t, e, n) {
        var r = W(t);
        return r.Zo(), new Ps(e, r.Ro, r.authCredentials, r.appCheckCredentials, r.M, n);
    }(t.datastore, t.asyncQueue, {
        Wr: sa.bind(null, t),
        Hr: ca.bind(null, t),
        Jo: aa.bind(null, t),
        ...
        return n(e, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return i ? (t.ma.xo(), [ 4 /*yield*/ , ra(t) ]) : [ 3 /*break*/ , 2 ];
                  ...
                  case 2:
                    return [ 4 /*yield*/ , t.ma.stop() ];

                  case 3:
                    e.sent(), t.ua.length > 0 && (q("RemoteStore", "Stopping write stream with " + t.ua.length + " pending writes"), 
                    t.ua = []), e.label = 4;
 ...
 */ function va(t, e) {
    if (B("AsyncQueue", e + ": " + t), li(t)) return new Y(H.UNAVAILABLE, e + ": " + t);
    throw t;
}
 ...
 */ var ya = /** @class */ function() {
    ...
    function t(t) {
        ...
        }, this.keyedMap = Kn(), this.sortedSet = new Rn(this.comparator)
        /**
    ...
    function t() {
        this.ga = new Rn(Ot.comparator);
    }
    return t.prototype.track = function(t) {
        var e = t.doc.key, n = this.ga.get(e);
        n ? 
        ...
        // Metadata->Added
        // Removed->Metadata
        G() : this.ga = this.ga.insert(e, t);
    }, t.prototype.ya = function() {
        var t = [];
        return this.ga.inorderTraversal((function(e, n) {
            t.push(n);
        })), t;
    }, t;
}(), ga = /** @class */ function() {
    ...
    this.queries = new Mn((function(t) {
        return je(t);
    }), Ke), this.onlineState = "Unknown" /* Unknown */ , this.Ia = new Set;
};
 ...
 */ function Ia(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                if (n = W(t), i = e.query, o = !1, (s = n.queries.get(i)) || (o = !0, s = new wa), 
                !o) return [ 3 /*break*/ , 4 ];
                r.label = 1;
              ...
              case 2:
                return a.pa = r.sent(), [ 3 /*break*/ , 4 ];

              case 3:
                return u = r.sent(), c = va(u, "Initialization of query '" + Ge(e.query) + "' failed"), 
                [ 2 /*return*/ , void e.onError(c) ];

              case 4:
                return n.queries.set(i, s), s.listeners.push(e), 
                // Run global snapshot listeners if a consistent snapshot has been emitted.
                e.Ta(n.onlineState), s.pa && e.Ea(s.pa) && _a(n), [ 2 /*return*/ ];
            }
        }));
    }));
}
 ...
 */ var Na = /** @class */ function() {
    ...
    return t.prototype.Ea = function(t) {
        if (!this.options.includeMetadataChanges) {
            ...
            t = new ga(t.query, t.docs, t.oldDocs, e, t.mutatedKeys, t.fromCache, t.syncStateChanged, 
            /* excludesMetadataChanges= */ !0);
        }
        var o = !1;
        return this.Ra ? this.Pa(t) && (this.Aa.next(t), o = !0) : this.Va(t, this.onlineState) && (this.va(t), 
        o = !0), this.ba = t, o;
    }, t.prototype.onError = function(t) {
        this.Aa.error(t);
    }, 
    /** Returns whether a snapshot was raised. */ t.prototype.Ta = function(t) {
        this.onlineState = t;
        var e = !1;
        ...
        var e = this.ba && this.ba.hasPendingWrites !== t.hasPendingWrites;
        return !(!t.syncStateChanged && !e) && !0 === this.options.includeMetadataChanges;
        // Generally we should have hit one of the cases above, but it's possible
        // to get here if there were only metadata docChanges and they got
        // stripped out.
        }, t.prototype.va = function(t) {
        t = ga.fromInitialDocuments(t.query, t.docs, t.mutatedKeys, t.fromCache), this.Ra = !0, 
        this.Aa.next(t);
    }, t;
}(), Da = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.Da = function() {
    ...
    t.prototype.fi = function(t) {
        return t.metadata.exists ? br(this.M, t.document, !1) : ie.newNoDocument(this.li(t.metadata.name), this.di(t.metadata.readTime));
    }, t.prototype.di = function(t) {
        return hr(t);
    }, t;
}(), Ca = /** @class */ function() {
    ...
    return t.prototype.xa = function(t) {
        ...
        for (var e = new Map, n = new Aa(this.M), r = 0, i = t; r < i.length; r++) {
            var o = i[r];
            if (o.metadata.queries) for (var s = n.li(o.metadata.name), a = 0, u = o.metadata.queries; a < u.length; a++) {
                var c = u[a], h = (e.get(c) || Qn()).add(s);
                e.set(c, h);
            }
        }
        return e;
    ...
    t.prototype.complete = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , is(this.localStore, new Aa(this.M), this.documents, this.Ca.id) ];

                  case 1:
                    t = r.sent(), e = this.Na(this.documents), n = 0, i = this.queries, r.label = 2;

                  case 2:
                    return n < i.length ? (o = i[n], [ 4 /*yield*/ , os(this.localStore, o, e.get(o.name)) ]) : [ 3 /*break*/ , 5 ];
                  ...
                  case 5:
                    return [ 2 /*return*/ , (this.progress.taskState = "Success", new qo(Object.assign({}, this.progress), t)) ];
                }
            }));
        }));
    }, t;
 ...
 */ var xa = function(t) {
    ...
    e) {
        ...
        this.mutatedKeys = Qn(), this.$a = Qe(t), this.Fa = new ya(this.$a);
    }
    ...
    t.prototype.La = function(t, e) {
        var n = this, r = e ? e.qa : new ma, i = e ? e.Fa : this.Fa, o = e ? e.mutatedKeys : this.mutatedKeys, s = i, a = !1, u = Ve(this.query) && i.size === this.query.limit ? i.last() : null, c = Le(this.query) && i.size === this.query.limit ? i.first() : null;
        // Drop documents out to meet limit/limitToLast requirement.
        if (t.inorderTraversal((function(t, e) {
            var h = i.get(t), l = ze(n.query, e) ? e : null, f = !!h && n.mutatedKeys.has(h.key), d = !!l && (l.hasLocalMutations || 
            ...
            h && l ? h.data.isEqual(l.data) ? f !== d && (r.track({
                type: 3 /* Metadata */ ,
                doc: l
            }), p = !0) : n.Ua(h, l) || (r.track({
                type: 2 /* Modified */ ,
                doc: l
            }), p = !0, (u && n.$a(l, u) > 0 || c && n.$a(l, c) < 0) && (
            ...
            a = !0)), p && (l ? (s = s.add(l), o = d ? o.add(t) : o.delete(t)) : (s = s.delete(t), 
            o = o.delete(t)));
        })), Ve(this.query) || Le(this.query)) for (;s.size > this.query.limit; ) {
    ...
    t.prototype.applyChanges = function(t, e, n) {
        ...
        o.sort((function(t, e) {
            return function(t, e) {
                ...
                return n(t) - n(e);
            }(t.type, e.type) || r.$a(t.doc, e.doc);
        })), this.Ka(n);
        var s = e ? this.Ga() : [], a = 0 === this.Oa.size && this.current ? 1 /* Synced */ : 0 /* Local */ , u = a !== this.Ma;
        return this.Ma = a, 0 !== o.length || u ? {
            snapshot: new ga(this.query, t.Fa, i, o, t.mutatedKeys, 0 /* Local */ === a, u, 
            /* excludesMetadataChanges= */ !1),
            Qa: s
        } : {
            Qa: s
    ...
    t.prototype.Ka = function(t) {
        ...
        // updating many documents.
                var e = this.Oa;
        this.Oa = Qn(), this.Fa.forEach((function(e) {
            t.ja(e.key) && (t.Oa = t.Oa.add(e.key));
        }));
        // Diff the new limbo docs with the old limbo docs.
        var n = [];
        return e.forEach((function(e) {
            t.Oa.has(e) || n.push(new Ma(e));
        })), this.Oa.forEach((function(t) {
            e.has(t) || n.push(new xa(t));
        })), n;
    }, 
    /**
    ...
    t.prototype.za = function() {
        return ga.fromInitialDocuments(this.query, this.Fa, this.mutatedKeys, 0 /* Local */ === this.Ma);
    }, t;
}(), Va = function(
/**
     * The query itself.
...
n) {
    ...
    r, i, o) {
        ...
        this.currentUser = i, this.maxConcurrentLimboResolutions = o, this.Ja = {}, this.Ya = new Mn((function(t) {
            return je(t);
        }), Ke), this.Xa = new Map, 
        /**
        ...
        /**
             ...
             * active target.
             */
        this.tu = new Rn(Ot.comparator), 
        /**
             * Keeps track of the information about an active limbo resolution for each
             * active target ID that was started for the purpose of limbo resolution.
             */
        this.eu = new Map, this.nu = new us, 
        /** Stores user completion handlers, indexed by User and BatchId. */
        this.su = {}, 
        /** Stores user callbacks waiting for all pending writes to be acknowledged. */
        this.iu = new Map, this.ru = vo.gn(), this.onlineState = "Unknown" /* Unknown */ , 
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                ...
                i = s.targetId, n.sharedClientState.addLocalQueryTarget(i), o = s.view.za(), [ 3 /*break*/ , 4 ]) : [ 3 /*break*/ , 1 ];

              case 1:
                return [ 4 /*yield*/ , $o(n.localStore, qe(e)) ];

              case 2:
                return a = r.sent(), n.isPrimaryClient && Gs(n.remoteStore, a), u = n.sharedClientState.addLocalQueryTarget(a.targetId), 
                i = a.targetId, [ 4 /*yield*/ , Pa(n, e, i, "current" === u) ];
                    ...
                    return function(t, e, i, o) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = e.view.La(i), n.ei ? [ 4 /*yield*/ , ts(t.localStore, e.query, 
                                    /* usePreviousResults= */ !1).then((function(t) {
                                        var r = t.documents;
                                        return e.view.La(r, n);
                                    })) ] : [ 3 /*break*/ , 2 ];
                                  ...
                                  case 2:
                                    ...
                                    /* updateLimboDocuments= */ t.isPrimaryClient, s), [ 2 /*return*/ , (Ja(t, e.targetId, a.Qa), 
                                    a.snapshot) ];
                                }
                            }));
                        }));
                    }(t, e, i, o);
                }, [ 4 /*yield*/ , ts(t.localStore, e, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return s = f.sent(), a = new Ra(e, s.hi), u = a.La(s.documents), c = Xn.createSynthesizedTargetChangeForCurrentChange(i, o && "Offline" /* Offline */ !== t.onlineState), 
                h = a.applyChanges(u, 
                /* updateLimboDocuments= */ t.isPrimaryClient, c), Ja(t, i, h.Qa), l = new Va(e, i, a), 
                [ 2 /*return*/ , (t.Ya.set(e, l), t.Xa.has(i) ? t.Xa.get(i).push(e) : t.Xa.set(i, [ e ]), 
                h.snapshot) ];
            }
        }));
    }));
...
/** Stops listening to the query. */ function Ua(t, e) {
    return n(this, void 0, void 0, (function() {
        var n, i, o;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return n = W(t), i = n.Ya.get(e), (o = n.Xa.get(i.targetId)).length > 1 ? [ 2 /*return*/ , (n.Xa.set(i.targetId, o.filter((function(t) {
                    return !Ke(t, e);
                }))), void n.Ya.delete(e)) ] : n.isPrimaryClient ? (
                // We need to remove the local query target first to allow us to verify
                // whether any other client is still interested in this target.
                n.sharedClientState.removeLocalQueryTarget(i.targetId), n.sharedClientState.isActiveQueryTarget(i.targetId) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Zo(n.localStore, i.targetId, 
                /*keepPersistedTargetData=*/ !1).then((function() {
                    n.sharedClientState.clearQueryState(i.targetId), zs(n.remoteStore, i.targetId), 
                    Ya(n, i.targetId);
                })).catch(bo) ]) : [ 3 /*break*/ , 3 ];
              ...
              case 3:
                return Ya(n, i.targetId), [ 4 /*yield*/ , Zo(n.localStore, i.targetId, 
            ...
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 5, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return r.persistence.runTransaction("Locally write mutations", "readwrite", (function(t) {
                        return r.ui.Us(t, o).next((function(o) {
                            n = o;
                            for (
                            ...
                            var s = [], a = 0, u = e; a < u.length; a++) {
                                var c = u[a], h = mn(c, n.get(c.key));
                                null != h && 
                                // NOTE: The base state should only be applied if there's some
                                // existing document to override, so use a Precondition of
                                // exists=true
                                s.push(new In(c.key, h, re(h.value.mapValue), fn.exists(!0)));
                            }
                            return r.Fs.addMutationBatch(t, i, s, e);
                        }));
                    })).then((function(t) {
              ...
              case 2:
                return o = r.sent(), n.sharedClientState.addPendingMutation(o.batchId), function(t, e, n) {
                    var r = t.su[t.currentUser.toKey()];
                    r || (r = new Rn(ct)), r = r.insert(e, n), t.su[t.currentUser.toKey()] = r;
                }(n, o.batchId, i), [ 4 /*yield*/ , tu(n, o.changes) ];

              case 3:
                return r.sent(), [ 4 /*yield*/ , ra(n.remoteStore) ];

              case 4:
                return r.sent(), [ 3 /*break*/ , 6 ];

              case 5:
                return s = r.sent(), a = va(s, "Failed to persist write"), i.reject(a), [ 3 /*break*/ , 6 ];
            ...
            switch (r.label) {
              ...
              case 2:
                ...
                e.targetChanges.forEach((function(t, e) {
                    ...
                    t.addedDocuments.size > 0 ? r.Ha = !0 : t.modifiedDocuments.size > 0 ? z(r.Ha) : t.removedDocuments.size > 0 && (z(r.Ha), 
                    r.Ha = !1));
                })), [ 4 /*yield*/ , tu(n, i, e) ];
 ...
 */ function Ka(t, e, n) {
    ...
    // SharedClientState.
        ...
        }(r.eventManager, e), i.length && r.Ja.Ko(i), r.onlineState = e, r.isPrimaryClient && r.sharedClientState.setOnlineState(e);
    }
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                // PORTING NOTE: Multi-tab only.
                return (n = W(t)).sharedClientState.updateQueryState(e, "rejected", i), o = n.eu.get(e), 
                (s = o && o.key) ? (
                // TODO(b/217189216): This limbo document should ideally have a read time,
                // so that it is picked up by any read-time based scans. The backend,
                // however, does not send a read time for target removals.
                a = (a = new Rn(Ot.comparator)).insert(s, ie.newNoDocument(s, dt.min())), u = Qn().add(s), 
                c = new Yn(dt.min(), 
                /* targetChanges= */ new Map, 
                /* targetMismatches= */ new On(ct), a, u), [ 4 /*yield*/ , Ba(n, c) ]) : [ 3 /*break*/ , 2 ];
              ...
              case 1:
                ...
                n.tu = n.tu.remove(s), n.eu.delete(e), Za(n), [ 3 /*break*/ , 4 ];

              case 2:
                return [ 4 /*yield*/ , Zo(n.localStore, e, 
                /* keepPersistedTargetData */ !1).then((function() {
                    return Ya(n, e, i);
                })).catch(bo) ];
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , Wo(n.localStore, e) ];
              ...
              case 2:
                ...
                Ha(n, i, /*error=*/ null), Wa(n, i), n.sharedClientState.updateMutationState(i, "acknowledged"), 
                [ 4 /*yield*/ , tu(n, o) ];
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return r.trys.push([ 1, 4, , 6 ]), [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Reject batch", "readwrite-primary", (function(t) {
                        var r;
                        return n.Fs.lookupMutationBatch(t, e).next((function(e) {
                            return z(null !== e), r = e.keys(), n.Fs.removeMutationBatch(t, e);
                        })).next((function() {
                            return n.Fs.performConsistencyCheck(t);
                        })).next((function() {
                            return n.ui.Us(t, r);
              ...
              case 2:
                ...
                // listen events.
                Ha(n, e, i), Wa(n, e), n.sharedClientState.updateMutationState(e, "rejected", i), 
                [ 4 /*yield*/ , tu(n, o) ];
 ...
 */ function Qa(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                Xs((n = W(t)).remoteStore) || q("SyncEngine", "The network is disabled. The task returned by 'awaitPendingWrites()' will not complete until the network is enabled."), 
                r.label = 1;
              ...
              case 1:
                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , function(t) {
                    ...
                    return e.persistence.runTransaction("Get highest unacknowledged batch id", "readonly", (function(t) {
                        return e.Fs.getHighestUnacknowledgedBatchId(t);
                    }));
                }(n.localStore) ];

              case 2:
                return -1 === (i = r.sent()) ? [ 2 /*return*/ , void e.resolve() ] : ((o = n.iu.get(i) || []).push(e), 
                n.iu.set(i, o), [ 3 /*break*/ , 4 ]);

              case 3:
                return s = r.sent(), a = va(s, "Initialization of waitForPendingWrites() operation failed"), 
...
function Ha(t, e, n) {
    var r = W(t), i = r.su[r.currentUser.toKey()];
    // NOTE: Mutations restored from persistence won't have callbacks, so it's
    // okay for there to be no callback for this ID.
    if (i) {
        var o = i.get(e);
        o && (n ? o.reject(n) : o.resolve(), i = i.remove(e)), r.su[r.currentUser.toKey()] = i;
    }
}

function Ya(t, e, n) {
    void 0 === n && (n = null), t.sharedClientState.removeLocalQueryTarget(e);
    for (var r = 0, i = t.Xa.get(e); r < i.length; r++) {
        var o = i[r];
        t.Ya.delete(o), n && t.Ja.uu(o, n);
    }
    t.Xa.delete(e), t.isPrimaryClient && t.nu.Ri(e).forEach((function(e) {
        t.nu.containsKey(e) || 
...
function Xa(t, e) {
    ...
    var n = t.tu.get(e);
    null !== n && (zs(t.remoteStore, n), t.tu = t.tu.remove(e), t.eu.delete(n), Za(t));
}

function Ja(t, e, n) {
    for (var r = 0, i = n; r < i.length; r++) {
        var o = i[r];
        o instanceof xa ? (t.nu.addReference(o.key, e), $a(t, o)) : o instanceof Ma ? (q("SyncEngine", "Document no longer in limbo: " + o.key), 
        t.nu.removeReference(o.key, e), t.nu.containsKey(o.key) || 
        // We removed the last reference for this key
        Xa(t, o.key)) : G();
    }
}
...
function $a(t, e) {
    ...
    t.tu.get(n) || t.Za.has(r) || (q("SyncEngine", "New document in limbo: " + n), t.Za.add(r), 
    Za(t));
}
 ...
 */ function Za(t) {
    for (;t.Za.size > 0 && t.tu.size < t.maxConcurrentLimboResolutions; ) {
        var e = t.Za.values().next().value;
        t.Za.delete(e);
        var n = new Ot(gt.fromString(e)), r = t.ru.next();
        t.eu.set(r, new La(n)), t.tu = t.tu.insert(n, r), Gs(t.remoteStore, new Ii(qe(Re(n.path)), r, 2 /* LimboResolution */ , st.A));
    }
}
...
function tu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(c) {
            switch (c.label) {
              case 0:
                return o = W(t), s = [], a = [], u = [], o.Ya.isEmpty() ? [ 3 /*break*/ , 3 ] : (o.Ya.forEach((function(t, n) {
                    u.push(o.au(n, e, i).then((function(t) {
                        if (t) {
                            o.isPrimaryClient && o.sharedClientState.updateQueryState(n.targetId, t.fromCache ? "not-current" : "current"), 
                            s.push(t);
                            var e = Ko.Js(n.targetId, t);
                            a.push(e);
                        }
                    })));
              ...
              case 1:
                return c.sent(), o.Ja.Ko(s), [ 4 /*yield*/ , function(t, e) {
                    return n(this, void 0, void 0, (function() {
                        var n, i, o, s, a, u, c, h, l;
                        return r(this, (function(r) {
                            switch (r.label) {
                              case 0:
                                n = W(t), r.label = 1;
                              ...
                              case 1:
                                return r.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , n.persistence.runTransaction("notifyLocalViewChanges", "readwrite", (function(t) {
                                    return si.forEach(e, (function(e) {
                                        return si.forEach(e.zs, (function(r) {
                                            return n.persistence.referenceDelegate.addReference(t, e.targetId, r);
                                        })).next((function() {
                                            return si.forEach(e.Hs, (function(r) {
                              ...
                              case 4:
                                for (o = 0, s = e; o < s.length; o++) a = s[o], u = a.targetId, a.fromCache || (c = n.si.get(u), 
                                h = c.snapshotVersion, l = c.withLastLimboFreeSnapshotVersion(h), 
                                // Advance the last limbo free snapshot version
                                n.si = n.si.insert(u, l));
                                return [ 2 /*return*/ ];
                            }
                        }));
                    }));
...
function eu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return (n = W(t)).currentUser.isEqual(e) ? [ 3 /*break*/ , 3 ] : (q("SyncEngine", "User change. New user:", e.toKey()), 
                [ 4 /*yield*/ , Qo(n.localStore, e) ]);

              case 1:
                return i = r.sent(), n.currentUser = e, 
                // Fails tasks waiting for pending writes requested by previous user.
                function(t, e) {
                    t.iu.forEach((function(t) {
                        t.forEach((function(t) {
                ...
                n.sharedClientState.handleUserChange(e, i.removedBatchIds, i.addedBatchIds), [ 4 /*yield*/ , tu(n, i.ci) ];
...
function nu(t, e) {
    var n = W(t), r = n.eu.get(e);
    if (r && r.Ha) return Qn().add(r.key);
    var i = Qn(), o = n.Xa.get(e);
    if (!o) return i;
    for (var s = 0, a = o; s < a.length; s++) {
        var u = a[s], c = n.Ya.get(u);
        i = i.unionWith(c.view.Ba);
    }
    return i;
}
 ...
 */ function ru(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return [ 4 /*yield*/ , ts((n = W(t)).localStore, e.query, 
                /* usePreviousResults= */ !0) ];

              case 1:
                return i = r.sent(), o = e.view.Wa(i), [ 2 /*return*/ , (n.isPrimaryClient && Ja(n, e.targetId, o.Qa), 
                o) ];
            }
        }));
    }));
...
function iu(t) {
    return n(this, void 0, void 0, (function() {
        var e;
        return r(this, (function(n) {
            return [ 2 /*return*/ , ns((e = W(t)).localStore).then((function(t) {
                return tu(e, t);
            })) ];
        }));
    }));
        ...
        return r(this, (function(r) {
            switch (r.label) {
                ...
                return [ 4 /*yield*/ , function(t, e) {
                    ...
                    return n.persistence.runTransaction("Lookup mutation documents", "readonly", (function(t) {
                        return r.ln(t, e).next((function(e) {
                            return e ? n.ui.Us(t, e) : si.resolve(null);
                        }));
                    }));
                }((n = W(t)).localStore, e) ];

              case 1:
                return null === (s = r.sent()) ? [ 3 /*break*/ , 6 ] : "pending" !== i ? [ 3 /*break*/ , 3 ] : [ 4 /*yield*/ , ra(n.remoteStore) ];
              ...
              case 3:
                ...
                // other clients.
                Ha(n, e, o || null), Wa(n, e), function(t, e) {
                    W(W(t).Fs).dn(e);
                }(n.localStore, e)) : G(), r.label = 4;

              case 4:
                return [ 4 /*yield*/ , tu(n, s) ];
...
function su(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return fu(n = W(t)), du(n), !0 !== e || !0 === n.ou ? [ 3 /*break*/ , 3 ] : (i = n.sharedClientState.getAllActiveQueryTargets(), 
                [ 4 /*yield*/ , au(n, i.toArray()) ]);

              case 1:
                return o = r.sent(), n.ou = !0, [ 4 /*yield*/ , la(n.remoteStore, !0) ];

              case 2:
                for (r.sent(), s = 0, a = o; s < a.length; s++) u = a[s], Gs(n.remoteStore, u);
                return [ 3 /*break*/ , 7 ];

              case 3:
                return !1 !== e || !1 === n.ou ? [ 3 /*break*/ , 7 ] : (c = [], h = Promise.resolve(), 
                n.Xa.forEach((function(t, e) {
                    n.sharedClientState.isLocalQueryTarget(e) ? c.push(e) : h = h.then((function() {
                        return Ya(n, e), Zo(n.localStore, e, 
                        /*keepPersistedTargetData=*/ !0);
                    })), zs(n.remoteStore, e);
                })), [ 4 /*yield*/ , h ]);
              ...
              case 5:
                ...
                function(t) {
                    var e = W(t);
                    e.eu.forEach((function(t, n) {
                        zs(e.remoteStore, n);
                    })), e.nu.bi(), e.eu = new Map, e.tu = new Rn(Ot.comparator);
                }(n), n.ou = !1, [ 4 /*yield*/ , la(n.remoteStore, !1) ];
...
function au(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, i, o, s, a, u, c, h, l, f, d, p, v, y;
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
              ...
              case 1:
                return s < a.length ? (u = a[s], c = void 0, (h = n.Xa.get(u)) && 0 !== h.length ? [ 4 /*yield*/ , $o(n.localStore, qe(h[0])) ] : [ 3 /*break*/ , 7 ]) : [ 3 /*break*/ , 13 ];
              ...
              case 3:
                return l < f.length ? (d = f[l], p = n.Ya.get(d), [ 4 /*yield*/ , ru(n, p) ]) : [ 3 /*break*/ , 6 ];
              ...
              case 7:
                return [ 4 /*yield*/ , es(n.localStore, u) ];

              case 8:
                return y = r.sent(), [ 4 /*yield*/ , $o(n.localStore, y) ];

              case 9:
                return c = r.sent(), [ 4 /*yield*/ , Pa(n, uu(y), u, 
                /*current=*/ !1) ];
...
function cu(t) {
    var e = W(t);
    return W(W(e.localStore).persistence).Ms();
}
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                if (!n.Xa.has(e)) return [ 3 /*break*/ , 8 ];
                switch (i) {
                  case "current":
                  case "not-current":
                    return [ 3 /*break*/ , 2 ];
              ...
              case 2:
                return [ 4 /*yield*/ , ns(n.localStore) ];

              case 3:
                return s = r.sent(), a = Yn.createSynthesizedRemoteEventForCurrentChange(e, "current" === i), 
                [ 4 /*yield*/ , tu(n, s, a) ];
              ...
              case 6:
                return r.sent(), Ya(n, e, o), [ 3 /*break*/ , 8 ];
...
/** Adds or removes Watch targets for queries from different tabs. */ function lu(t, e, i) {
    return n(this, void 0, void 0, (function() {
        var n, o, s, a, u, c, h, l, f, d;
        return r(this, (function(p) {
            switch (p.label) {
              case 0:
                if (!(n = fu(t)).ou) return [ 3 /*break*/ , 10 ];
                o = 0, s = e, p.label = 1;

              case 1:
                return o < s.length ? (a = s[o], n.Xa.has(a) ? (
                // A target might have been added in a previous attempt
                q("SyncEngine", "Adding an already active target " + a), [ 3 /*break*/ , 5 ]) : [ 4 /*yield*/ , es(n.localStore, a) ]) : [ 3 /*break*/ , 6 ];

              case 2:
                return u = p.sent(), [ 4 /*yield*/ , $o(n.localStore, u) ];

              case 3:
                return c = p.sent(), [ 4 /*yield*/ , Pa(n, uu(u), c.targetId, 
                /*current=*/ !1) ];

              case 4:
                p.sent(), Gs(n.remoteStore, c), p.label = 5;
              ...
              case 6:
                h = function(t) {
                    return r(this, (function(e) {
                        switch (e.label) {
                          case 0:
                            return n.Xa.has(t) ? [ 4 /*yield*/ , Zo(n.localStore, t, 
                            /* keepPersistedTargetData */ !1).then((function() {
                                zs(n.remoteStore, t), Ya(n, t);
                            })).catch(bo) ] : [ 3 /*break*/ , 2 ];
...
function fu(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applyRemoteEvent = Ba.bind(null, e), e.remoteStore.remoteSyncer.getRemoteKeysForTarget = nu.bind(null, e), 
    e.remoteStore.remoteSyncer.rejectListen = ja.bind(null, e), e.Ja.Ko = Ta.bind(null, e.eventManager), 
    e.Ja.uu = Sa.bind(null, e.eventManager), e;
}

function du(t) {
    var e = W(t);
    return e.remoteStore.remoteSyncer.applySuccessfulWrite = Ga.bind(null, e), e.remoteStore.remoteSyncer.rejectFailedWrite = za.bind(null, e), 
    e
    /**
        ...
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 4:
                    return i._updateProgress(ka(n)), o = new Ca(n, t.localStore, e.M), [ 4 /*yield*/ , e.cu() ];

                  case 5:
                    s = r.sent(), r.label = 6;

                  case 6:
                    return s ? [ 4 /*yield*/ , o.xa(s) ] : [ 3 /*break*/ , 10 ];

                  case 7:
                    return (a = r.sent()) && i._updateProgress(a), [ 4 /*yield*/ , e.cu() ];
                  ...
                  case 11:
                    ...
                    // has newer version.
                    return u = r.sent(), [ 4 /*yield*/ , tu(t, u.$s, 
                    /* remoteEvent */ void 0) ];
                  ...
                  case 12:
                    ...
                    return r.sent(), [ 4 /*yield*/ , function(t, e) {
                        ...
                        return n.persistence.runTransaction("Save bundle", "readwrite", (function(t) {
                            return n.fs.saveBundleMetadata(t, e);
                        }));
                    }(t.localStore, n) ];
...
var vu = /** @class */ function() {
    ...
    return t.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return this.M = Vs(t.databaseInfo.databaseId), this.sharedClientState = this.hu(t), 
                    this.persistence = this.lu(t), [ 4 /*yield*/ , this.persistence.start() ];

                  case 1:
                    return e.sent(), this.gcScheduler = this.fu(t), this.localStore = this.du(t), [ 2 /*return*/ ];
                }
            }));
        }));
    ...
    function i(t, n, r) {
        var i = this;
        return (i = e.call(this) || this)._u = t, i.cacheSizeBytes = n, i.forceOwnership = r, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  ...
                  case 1:
                    return r.sent(), [ 4 /*yield*/ , rs(this.localStore) ];

                  case 2:
                    return r.sent(), [ 4 /*yield*/ , this._u.initialize(this, t) ];

                  case 3:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , du(this._u.syncEngine) ];

                  case 4:
                    // Enqueue writes from a previous session
                    return r.sent(), [ 4 /*yield*/ , ra(this._u.remoteStore) ];

                  case 5:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return r.sent(), [ 4 /*yield*/ , this.persistence.ps((function() {
        ...
        return new To(e, t.asyncQueue);
    }, i.prototype.lu = function(t) {
        var e = Uo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey), n = void 0 !== this.cacheSizeBytes ? so.withCacheSize(this.cacheSizeBytes) : so.DEFAULT;
        return new Oo(this.synchronizeTabs, e, t.clientId, n, t.asyncQueue, Ms(), Rs(), this.M, this.sharedClientState, !!this.forceOwnership);
    }, i.prototype.hu = function(t) {
        return new Ns;
    }, i;
}(vu), mu = /** @class */ function(e) {
    function i(t, n) {
        var r = this;
        return (r = e.call(this, t, n, /* forceOwnership= */ !1) || this)._u = t, r.cacheSizeBytes = n, 
    ...
    return t(i, e), i.prototype.initialize = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(s) {
                switch (s.label) {
                  ...
                  case 1:
                    return s.sent(), i = this._u.syncEngine, this.sharedClientState instanceof _s ? (this.sharedClientState.syncEngine = {
                        Nr: ou.bind(null, i),
                        kr: hu.bind(null, i),
                        Mr: lu.bind(null, i),
                        Ms: cu.bind(null, i),
                  ...
                  case 3:
                    // NOTE: This will immediately call the listener, so we make sure to
                    // set it after localStore / remoteStore are started.
                    return [ 4 /*yield*/ , this.persistence.ps((function(t) {
                        return n(o, void 0, void 0, (function() {
                            return r(this, (function(e) {
                                switch (e.label) {
                                  case 0:
                                    return [ 4 /*yield*/ , su(this._u.syncEngine, t) ];
        ...
        var e = Ms();
        if (!_s.vt(e)) throw new Y(H.UNIMPLEMENTED, "IndexedDB persistence is only available on platforms that support LocalStorage.");
        var n = Uo(t.databaseInfo.databaseId, t.databaseInfo.persistenceKey);
        return new _s(e, t.asyncQueue, n, t.clientId, t.initialUser);
    }, i;
}(yu), gu = /** @class */ function() {
    function t() {}
    return t.prototype.initialize = function(t, e) {
                ...
                switch (r.label) {
                  case 0:
                    ...
                    /* startAsPrimary=*/ !t.synchronizeTabs), this.sharedClientState.onlineStateHandler = function(t) {
                        return Ka(n.syncEngine, t, 1 /* SharedClientState */);
                    }, this.remoteStore.remoteSyncer.handleCredentialChange = eu.bind(null, this.syncEngine), 
                    [ 4 /*yield*/ , la(this.remoteStore, this.syncEngine.isPrimaryClient) ]);
        ...
        var e, n = Vs(t.databaseInfo.databaseId), r = (e = t.databaseInfo, new xs(e));
        ...
        return e = this.localStore, n = this.datastore, r = t.asyncQueue, i = function(t) {
            return Ka(s.syncEngine, t, 0 /* RemoteStore */);
        }, o = As.vt() ? new As : new Ds, new Bs(e, n, r, i, o);
    }, t.prototype.createSyncEngine = function(t, e) {
        return function(t, e, n, 
        // PORTING NOTE: Manages state synchronization in multi-tab environments.
        r, i, o, s) {
            var a = new Oa(t, e, n, r, i, o);
            return s && (a.ou = !0), a;
        ...
        return function(t) {
            return n(this, void 0, void 0, (function() {
                ...
                return r(this, (function(n) {
                    switch (n.label) {
                      case 0:
                        return e = W(t), q("RemoteStore", "RemoteStore shutting down."), e.ha.add(5 /* Shutdown */), 
                        [ 4 /*yield*/ , js(e) ];

                      case 1:
                        return n.sent(), e.fa.shutdown(), 
                        // Set the OnlineState to Unknown (rather than Offline) to avoid potentially
                        // triggering spurious listener events with cached data, etc.
                        e.da.set("Unknown" /* Unknown */), [ 2 /*return*/ ];
                    }
                }));
            }));
        }(this.remoteStore);
 ...
 */ var bu = /** @class */ function() {
    ...
    t, e) {
        ...
        this.pu().then((function(t) {
            t && t.Da() ? n.metadata.resolve(t.payload.metadata) : n.metadata.reject(new Error("The first element of the bundle is not a metadata, it is\n             " + JSON.stringify(null == t ? void 0 : t.payload)));
        }), (function(t) {
            ...
            return r(this, (function(t) {
                switch (t.label) {
                  ...
                  case 1:
                    ...
                    return [ 2 /*return*/ , (t.sent(), this.pu()) ];
                }
            }));
        }));
    }, 
    ...
    t.prototype.pu = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return [ 4 /*yield*/ , this.Iu() ];

                  case 1:
                    return null === (t = r.sent()) ? [ 2 /*return*/ , null ] : (e = this.yu.decode(t), 
                    n = Number(e), isNaN(n) && this.Tu("length string (" + e + ") is not valid number"), 
                    [ 4 /*yield*/ , this.Eu(n) ]);

                  case 2:
                    return i = r.sent(), [ 2 /*return*/ , new Da(JSON.parse(i), t.length + n) ];
                }
            }));
        }));
    }, 
    /** First index of '{' from the underlying buffer. */ t.prototype.Au = function() {
    ...
    t.prototype.Iu = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.Au() < 0 ? [ 4 /*yield*/ , this.Ru() ] : [ 3 /*break*/ , 3 ];
                  ...
                  case 3:
                    ...
                    (t = this.Au()) < 0 && this.Tu("Reached the end of bundle when a length string is expected."), 
    ...
    t.prototype.Eu = function(t) {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    return this.buffer.length < t ? [ 4 /*yield*/ , this.Ru() ] : [ 3 /*break*/ , 3 ];

                  case 1:
                    n.sent() && this.Tu("Reached the end of bundle when more is expected."), n.label = 2;
                  ...
                  case 3:
                    ...
                    return e = this.yu.decode(this.buffer.slice(0, t)), [ 2 /*return*/ , (this.buffer = this.buffer.slice(t), 
                    e) ];
                }
            }));
        }));
                    ...
                    return [ 4 /*yield*/ , function(t, e) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(r) {
                                switch (r.label) {
                                  case 0:
                                    return n = W(t), i = mr(n.M) + "/documents", o = {
                                        documents: e.map((function(t) {
                                            return dr(n.M, t);
                                        }))
                                    }, [ 4 /*yield*/ , n.uo("BatchGetDocuments", i, o) ];
                                    ...
                                    return s = r.sent(), a = new Map, s.forEach((function(t) {
                                        var e = function(t, e) {
                                            return "found" in e ? function(t, e) {
                                                ...
                                                var n = pr(t, e.found.name), r = hr(e.found.updateTime), i = new ne({
                                                    mapValue: {
                                                ...
                                                var n = pr(t, e.missing), r = hr(e.readTime);
            ...
            return r(this, (function(i) {
                switch (i.label) {
                  case 0:
                    ...
                    t.forEach((function(t, n) {
                        var r = Ot.fromPath(n);
                        e.mutations.push(new An(r, e.precondition(r)));
    ...
    t.prototype.precondition = function(t) {
        ...
        return !this.writtenDocs.has(t.toString()) && e ? fn.updateTime(e) : fn.none();
    }, 
    /**
    ...
    function t(t, e, n, r) {
        ...
        this.bu = 5, this.vo = new Ls(this.asyncQueue, "transaction_retry" /* TransactionRetry */)
    ...
    return t.prototype.run = function() {
        ...
        this.vo.po((function() {
            return n(t, void 0, void 0, (function() {
                var t, e, n = this;
                return r(this, (function(r) {
                    return t = new Eu(this.datastore), (e = this.Vu(t)) && e.then((function(e) {
        ...
        var e = this;
        this.bu > 0 && this.Su(t) ? (this.bu -= 1, this.asyncQueue.enqueueAndForget((function() {
            return e.Pu(), Promise.resolve();
    ...
    i, o) {
        ...
        this.user = L.UNAUTHENTICATED, this.clientId = ut.R(), this.authCredentialListener = function() {
            return Promise.resolve();
            ...
            return q("FirestoreClient", "Received new app check token=", t), s.appCheckCredentialListener(t, s.user);
        }));
    }
            ...
            return n(t, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 5:
                        return t = r.sent(), n = va(t, "Failed to shutdown persistence"), e.reject(n), [ 3 /*break*/ , 6 ];
                ...
                return a.sent(), o = i.initialUser, t.setCredentialChangeListener((function(t) {
                    return n(s, void 0, void 0, (function() {
                        return r(this, (function(n) {
                            switch (n.label) {
                              case 0:
                                return o.isEqual(t) ? [ 3 /*break*/ , 2 ] : [ 4 /*yield*/ , Qo(e.localStore, t) ];
...
function Nu(t, e) {
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              case 0:
                return t.asyncQueue.verifyOperationInProgress(), [ 4 /*yield*/ , Du(t) ];

              case 1:
                return n = r.sent(), q("FirestoreClient", "Initializing OnlineComponentProvider"), 
                [ 4 /*yield*/ , t.getConfiguration() ];
              ...
              case 3:
                ...
                t.setCredentialChangeListener((function(t) {
                    return ha(e.remoteStore, t);
                })), t.setAppCheckTokenChangeListener((function(t, n) {
                    return ha(e.remoteStore, n);
    ...
    return n(this, void 0, void 0, (function() {
        ...
        return r(this, (function(r) {
            switch (r.label) {
              ...
              case 1:
                return e = r.sent(), [ 2 /*return*/ , ((n = e.eventManager).onListen = Fa.bind(null, e.syncEngine), 
                n.onUnlisten = Ua.bind(null, e.syncEngine), n) ];
            }
        }));
    }));
}
 ...
 */ function Uu(t) {
    if (!Ot.isDocumentKey(t)) throw new Y(H.INVALID_ARGUMENT, "Invalid document reference. Document references must have an even number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */ function qu(t) {
    if (Ot.isDocumentKey(t)) throw new Y(H.INVALID_ARGUMENT, "Invalid collection reference. Collection references must have an odd number of segments, but " + t + " has " + t.length + ".");
}
 ...
 */
/** Returns a string describing the type / value of the provided input. */ function Bu(t) {
 ...
 */ var Gu = /** @class */ function() {
    function t(t) {
        ...
        this.useFetchStreams = !!t.useFetchStreams, Pu("experimentalForceLongPolling", t.experimentalForceLongPolling, "experimentalAutoDetectLongPolling", t.experimentalAutoDetectLongPolling);
    }
    ...
    function t(t, e, n) {
        ...
        /**
             ...
             */
        this.type = "firestore-lite", this._persistenceKey = "(lite)", this._settings = new Gu({}), 
    ...
    return Object.defineProperty(t.prototype, "app", {
        ...
        this._settings = new Gu(t), void 0 !== t.credentials && (this._authCredentials = function(t) {
            if (!t) return new $;
            switch (t.type) {
              case "gapi":
                var e = t.client;
 ...
 */
        return t = this, (e = Ou.get(t)) && (q("ComponentProvider", "Removing Datastore"), 
        Ou.delete(t), e.terminate()), Promise.resolve();
        var t, e;
    }, t;
}();
 ...
 */ function Xu(t, n) {
    ...
    if (t = I(t), Fu("collection", "path", n), t instanceof zu) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return qu(o), new Yu(t, /* converter= */ null, o);
    }
    if (!(t instanceof Wu || t instanceof Yu)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return qu(s), new Yu(t.firestore, 
    /* converter= */ null, s);
}
 ...
 */ function Ju(t, e) {
    if (t = Ku(t, zu), Fu("collectionGroup", "collection id", e), e.indexOf("/") >= 0) throw new Y(H.INVALID_ARGUMENT, "Invalid collection ID '" + e + "' passed to function collectionGroup(). Collection IDs must not contain '/'.");
    return new Hu(t, 
    /* converter= */ null, 
    /**
...
function $u(t, n) {
    ...
    // 'undefined' and 'null'.
    1 === arguments.length && (n = ut.R()), Fu("doc", "path", n), t instanceof zu) {
        var o = gt.fromString.apply(gt, e([ n ], r));
        return Uu(o), new Wu(t, 
        /* converter= */ null, new Ot(o));
    }
    if (!(t instanceof Wu || t instanceof Yu)) throw new Y(H.INVALID_ARGUMENT, "Expected first argument to collection() to be a CollectionReference, a DocumentReference or FirebaseFirestore");
    var s = t._path.child(gt.fromString.apply(gt, e([ n ], r)));
    return Uu(s), new Wu(t.firestore, t instanceof Yu ? t.converter : null, new Ot(s));
}
 ...
 * Firestore database.
 */ function Zu(t, e) {
    return t = I(t), e = I(e), (t instanceof Wu || t instanceof Yu) && (e instanceof Wu || e instanceof Yu) && t.firestore === e.firestore && t.path === e.path && t.converter === e.converter
    /**
...
function tc(t, e) {
    return t = I(t), e = I(e), t instanceof Hu && e instanceof Hu && t.firestore === e.firestore && Ke(t._query, e._query) && t.converter === e.converter
    /**
 * @license
 * Copyright 2020 Google LLC
 *
...
var ec = /** @class */ function() {
    function t() {
        ...
        this.vo = new Ls(this, "async_queue_retry" /* AsyncQueueRetry */), 
        // Visibility handler that triggers an immediate retry of all retryable
        // operations. Meant to speed up recovery when we regain file system access
        // after page comes into foreground.
        this.Fu = function() {
            var e = Rs();
            e && q("AsyncQueue", "Visibility state changed to " + e.visibilityState), t.vo.To();
        };
        var e = Rs();
        e && "function" == typeof e.addEventListener && e.addEventListener("visibilitychange", this.Fu);
    }
    ...
    t.prototype.enqueueAndForget = function(t) {
        ...
        // advance the queue even when the operation is not run.
                var n = new X;
        return this.Lu((function() {
            return e.xu && e.Ou ? Promise.resolve() : (t().then(n.resolve, n.reject), n.promise);
        })).then((function() {
            return n.promise;
        }));
    ...
    t.prototype.qu = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(n) {
                switch (n.label) {
                  case 0:
                    if (0 === this.Cu.length) return [ 3 /*break*/ , 5 ];
                    n.label = 1;

                  case 1:
                    return n.trys.push([ 1, 3, , 4 ]), [ 4 /*yield*/ , this.Cu[0]() ];

                  case 2:
                    return n.sent(), this.Cu.shift(), this.vo.reset(), [ 3 /*break*/ , 4 ];
        ...
        var e = this, n = this.Du.then((function() {
            return e.Mu = !0, t().catch((function(t) {
                e.ku = t, e.Mu = !1;
                var n = 
                /**
 ...
 */
        ...
        var i = pa.createAndSchedule(this, t, e, n, (function(t) {
            return r.Uu(t);
        }));
    ...
    t.prototype.Ku = function() {
        return n(this, void 0, void 0, (function() {
            ...
            return r(this, (function(e) {
                switch (e.label) {
                  case 0:
                    return [ 4 /*yield*/ , t = this.Du ];

                  case 1:
                    e.sent(), e.label = 2;

                  case 2:
                    if (t !== this.Du) return [ 3 /*break*/ , 0 ];
                    e.label = 3;
...
function cc(t) {
    var e, n = t._freezeSettings(), r = function(t, e, n, r) {
        return new xt(t, e, n, r.host, r.ssl, r.experimentalForceLongPolling, r.experimentalAutoDetectLongPolling, r.useFetchStreams);
    }(t._databaseId, (null === (e = t._app) || void 0 === e ? void 0 : e.options.appId) || "", t._persistenceKey, n);
    t._firestoreClient = new Su(t._authCredentials, t._appCheckCredentials, t._queue, r);
}
 ...
 */ function hc(t, e) {
    bc(t = Ku(t, oc));
    var n = uc(t), r = t._freezeSettings(), i = new gu;
    return fc(n, i, new yu(i, r.cacheSizeBytes, null == e ? void 0 : e.forceOwnership));
}
 ...
 */ function lc(t) {
    bc(t = Ku(t, oc));
    var e = uc(t), n = t._freezeSettings(), r = new gu;
    return fc(e, r, new mu(r, n.cacheSizeBytes));
}
    ...
    return t.asyncQueue.enqueue((function() {
        return n(o, void 0, void 0, (function() {
            ...
            return r(this, (function(r) {
                switch (r.label) {
                  case 0:
                    return r.trys.push([ 0, 3, , 4 ]), [ 4 /*yield*/ , _u(t, i) ];

                  case 1:
                    return r.sent(), [ 4 /*yield*/ , Nu(t, e) ];
            ...
            return r(this, (function(o) {
                switch (o.label) {
                  case 0:
                    return o.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , function(t) {
                        return n(this, void 0, void 0, (function() {
                            ...
                            return r(this, (function(n) {
                                switch (n.label) {
                                  case 0:
                                    return ui.vt() ? (e = t + "main", [ 4 /*yield*/ , ui.delete(e) ]) : [ 2 /*return*/ , Promise.resolve() ];
                    ...
                    }(Uo(t._databaseId, t._persistenceKey)) ];
 ...
 */ function vc(t) {
            ...
            return n(e, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return e = r.sent(), [ 4 /*yield*/ , xu(t) ];

                      case 2:
                        return n = r.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!0), function(t) {
                            var e = W(t);
                            return e.ha.delete(0 /* UserDisabled */), Ks(e);
                        }(n)) ];
                    }
                }));
            }));
    ...
    /** Disables the network connection. Pending operations will not complete. */ (uc(t = Ku(t, oc)));
}
                        ...
                        return i = o.sent(), [ 2 /*return*/ , (e.setNetworkEnabled(!1), function(t) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(n) {
                                    switch (n.label) {
                                      case 0:
                                        return (e = W(t)).ha.add(0 /* UserDisabled */), [ 4 /*yield*/ , js(e) ];

                                      case 1:
                                        return n.sent(), 
                                        // Set the OnlineState to Offline so get()s return from cache, etc.
                                        e.da.set("Offline" /* Offline */), [ 2 /*return*/ ];
                                    }
                                }));
                            }));
                        }(i)) ];
...
function gc(t, e) {
    var i = uc(t = Ku(t, oc)), o = new rc;
    return function(t, e, i, o) {
        var s = this, a = function(t, e) {
            return function(t, e) {
                return new Iu(t, e);
            }(function(t, e) {
                if (t instanceof Uint8Array) return wu(t, e);
                if (t instanceof ArrayBuffer) return wu(new Uint8Array(t), e);
...
function wc(t, e) {
    ...
    }(uc(t = Ku(t, oc)), e).then((function(e) {
        return e ? new Hu(t, null, e.query) : null;
    }));
}
...
function(t) {
...
}(), Nc = /^__.*__$/, Dc = /** @class */ function() {
    function t(t, e, n) {
        this.data = t, this.fieldMask = e, this.fieldTransforms = n;
    }
    return t.prototype.toMutation = function(t, e) {
        return null !== this.fieldMask ? new In(t, this.data, this.fieldMask, e, this.fieldTransforms) : new bn(t, this.data, e, this.fieldTransforms);
    }, t;
}(), Ac = /** @class */ function() {
    function t(t, 
    ...
    return t.prototype.toMutation = function(t, e) {
        return new In(t, this.data, this.fieldMask, e, this.fieldTransforms);
    }, t;
}();
...
/** A "context" object passed around while parsing user data. */ var kc = /** @class */ function() {
    /**
    ...
    function t(t, e, n, r, i, o) {
        ...
        void 0 === i && this.Wu(), this.fieldTransforms = i || [], this.fieldMask = o || [];
    }
    ...
    /** Returns a new context with the specified settings overwritten. */ t.prototype.Hu = function(e) {
        ...
        return Xc(t, this.settings.methodName, this.settings.nc || !1, this.path, this.settings.sc);
    }, 
    /** Returns 'true' if 'fieldPath' was traversed when creating this context. */ t.prototype.contains = function(t) {
        ...
        // within arrays.
        if (this.path) for (var t = 0; t < this.path.length; t++) this.Xu(this.path.get(t));
    }, t.prototype.Xu = function(t) {
        if (0 === t.length) throw this.ec("Document fields must not be empty");
        if (Cc(this.zu) && Nc.test(t)) throw this.ec('Document fields cannot begin and end with "__"');
    }, t;
}(), xc = /** @class */ function() {
    function t(t, e, n) {
        this.databaseId = t, this.ignoreUndefinedProperties = e, this.M = n || Vs(t)
        /** Creates a new top-level parse context. */;
    }
    return t.prototype.ic = function(t, e, n, r) {
        return void 0 === r && (r = !1), new kc({
            zu: t,
            methodName: e,
            sc: n,
            path: bt.emptyPath(),
 ...
 * classes.
 */ function Mc(t) {
    var e = t._freezeSettings(), n = Vs(t._databaseId);
    return new xc(t._databaseId, !!e.ignoreUndefinedProperties, n);
}

/** Parse document data from a set() call. */ function Rc(t, e, n, r, i, o) {
    void 0 === o && (o = {});
    var s = t.ic(o.merge || o.mergeFields ? 2 /* MergeSet */ : 0 /* Set */ , e, n, i);
    Qc("Data must be an object, but it was:", s, r);
    var a, u, c = Gc(r, s);
...
var Oc = /** @class */ function(e) {
    ...
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).rc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = Lc(this, t, 
        /*array=*/ !0), n = this.rc.map((function(t) {
            return jc(t, e);
        })), r = new nn(n);
        return new hn(t.path, r);
    }, n.prototype.isEqual = function(t) {
        // TODO(mrschmidt): Implement isEquals
        return this === t;
    }, n;
}(Sc), Pc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).rc = n, r;
    }
...
}(Sc), Uc = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this, t) || this).oc = n, r;
    }
    return t(n, e), n.prototype._toFieldTransform = function(t) {
        var e = new an(t.M, Xe(t.M, this.oc));
...
/** Parse update data from an update() call. */ function qc(t, e, n, r) {
    var i = t.ic(1 /* Update */ , e, n);
    Qc("Data must be an object, but it was:", i, r);
    var o = [], s = ne.empty();
    vt(r, (function(t, r) {
        var a = Yc(e, t, n);
    ...
    var a = new It(o);
    return new Ac(s, a, i.fieldTransforms);
}

/** Parse update data from a list of field/value arguments. */ function Bc(t, e, n, r, i, o) {
    var s = t.ic(1 /* Update */ , e, n), a = [ Wc(e, r, n) ], u = [ i ];
    ...
    for (var c = 0; c < o.length; c += 2) a.push(Wc(e, o[c])), u.push(o[c + 1]);
    // We iterate in reverse order to pick the last value for a field if the
    // user specified the field multiple times.
    for (var h = [], l = ne.empty(), f = a.length - 1; f >= 0; --f) if (!Jc(h, a[f])) {
        var d = a[f], p = u[f];
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
        p = I(p);
        ...
        h.push(d); else {
            var y = jc(p, v);
            null != y && (h.push(d), l.set(d, y));
        }
    }
    var m = new It(h);
    return new Ac(l, m, s.fieldTransforms);
}
 ...
 */ function Kc(t, e, n, r) {
    return void 0 === r && (r = !1), jc(n, t.ic(r ? 4 /* ArrayArgument */ : 3 /* Argument */ , e));
}
 ...
 */ function jc(t, e) {
    ...
    // from firestore-exp.
    t = I(t))) return Qc("Unsupported field value:", e, t), Gc(t, e);
    if (t instanceof Sc) 
    ...
    return function(t, e) {
        ...
        if (!Cc(e.zu)) throw e.ec(t._methodName + "() can only be used with update() and set()");
    ...
    return function(t, e) {
        ...
        if ("number" == typeof t) return Xe(e.M, t);
        ...
        if (t instanceof ft) {
            ...
            return {
                timestampValue: ar(e.M, r)
            };
        }
        if (t instanceof _c) return {
            geoPointValue: {
                latitude: t.latitude,
        ...
        if (t instanceof Tc) return {
            bytesValue: ur(e.M, t._byteString)
        };
        if (t instanceof Wu) {
            var i = e.databaseId, o = t.firestore._databaseId;
            if (!o.isEqual(i)) throw e.ec("Document reference is for database " + o.projectId + "/" + o.database + " but should be for database " + i.projectId + "/" + i.database);
            return {
                referenceValue: lr(t.firestore._databaseId || e.databaseId, t._key.path)
            };
        }
        throw e.ec("Unsupported field value: " + Bu(t));
    }(t, e);
}
...
function zc(t) {
    return !("object" != typeof t || null === t || t instanceof Array || t instanceof Date || t instanceof ft || t instanceof _c || t instanceof Tc || t instanceof Wu || t instanceof Sc);
}
...
function Qc(t, e, n) {
    if (!zc(n) || !function(t) {
        ...
        var r = Bu(n);
        throw "an object" === r ? e.ec(t + " a custom object") : e.ec(t + " " + r);
    }
}
 ...
 */ function Wc(t, e, n) {
    ...
    // FieldPath.
    (e = I(e)) instanceof Ic) return e._internalPath;
    if ("string" == typeof e) return Yc(t, e);
    throw Xc("Field path arguments must be of type string or ", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, n);
}
 ...
 * evaluated.
 */ function Yc(t, n, r) {
    if (n.search(Hc) >= 0) throw Xc("Invalid field path (" + n + "). Paths must not contain '~', '*', '/', '[', or ']'", t, 
    /* hasConverter= */ !1, 
    /* path= */ void 0, r);
    try {
        return (new (Ic.bind.apply(Ic, e([ void 0 ], n.split(".")))))._internalPath;
    } catch (e) {
        throw Xc("Invalid field path (" + n + "). Paths must not be empty, begin with '.', end with '.', or contain '..'", t, 
        /* hasConverter= */ !1, 
        /* path= */ void 0, r);
    }
}
    ...
    t.prototype.data = function() {
        if (this._document) {
            if (this._converter) {
                ...
                var t = new Zc(this._firestore, this._userDataWriter, this._key, this._document, 
                /* converter= */ null);
 ...
 */
function th(t, e) {
    return "string" == typeof e ? Yc(t, e) : e instanceof Ic ? e._internalPath : e._delegate._internalPath;
}
 ...
 */ var eh = /** @class */ function() {
...
}(nh), ih = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e, n, r) {
        this._firestore = t, this._userDataWriter = e, this._snapshot = r, this.metadata = new eh(r.hasPendingWrites, r.fromCache), 
        this.query = n;
    }
    ...
    t.prototype.forEach = function(t, e) {
        ...
        this._snapshot.docs.forEach((function(r) {
            t.call(e, new rh(n._firestore, n._userDataWriter, r.key, r, new eh(n._snapshot.mutatedKeys.has(r.key), n._snapshot.fromCache), n.query.converter));
        }));
    }, 
    /**
        ...
        function(t, e) {
            if (t._snapshot.oldDocs.isEmpty()) {
                ...
                return t._snapshot.docChanges.map((function(e) {
                    return {
                        type: "added",
                        doc: new rh(t._firestore, t._userDataWriter, e.doc.key, e.doc, new eh(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter),
                        oldIndex: -1,
                        newIndex: n++
                    };
                }));
            ...
            return t._snapshot.docChanges.filter((function(t) {
                ...
                var n = new rh(t._firestore, t._userDataWriter, e.doc.key, e.doc, new eh(t._snapshot.mutatedKeys.has(e.doc.key), t._snapshot.fromCache), t.query.converter), i = -1, o = -1;
 ...
 */ function sh(t, e) {
    return t instanceof nh && e instanceof nh ? t._firestore === e._firestore && t._key.isEqual(e._key) && (null === t._document ? null === e._document : t._document.isEqual(e._document)) && t._converter === e._converter : t instanceof ih && e instanceof ih && t._firestore === e._firestore && tc(t.query, e.query) && t.metadata.isEqual(e.metadata) && t._snapshot.isEqual(e._snapshot);
}
 ...
 * limitations under the License.
 */ function ah(t) {
    if (Le(t) && 0 === t.explicitOrderBy.length) throw new Y(H.UNIMPLEMENTED, "limitToLast() queries require specifying at least one orderBy() clause");
}
...
var hh = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).ac = t, i.uc = n, i.cc = r, i.type = "where", 
        i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Mc(t.firestore), n = function(t, e, n, r, i, o, s) {
            var a;
            if (i.isKeyField()) {
            ...
            } else "in" /* IN */ !== o && "not-in" /* NOT_IN */ !== o && "array-contains-any" /* ARRAY_CONTAINS_ANY */ !== o || _h(s, o), 
            a = Kc(n, "where", s, 
            /* allowArrays= */ "in" /* IN */ === o || "not-in" /* NOT_IN */ === o);
            var f = me.create(i, o, a);
            return function(t, e) {
                if (e.S()) {
                    var n = Fe(t);
 ...
 */
        ...
        }(t._query, 0, e, t.firestore._databaseId, this.ac, this.uc, this.cc);
...
var fh = /** @class */ function(e) {
    function n(t, n) {
        var r = this;
        return (r = e.call(this) || this).ac = t, r.hc = n, r.type = "orderBy", r;
    }
    return t(n, e), n.prototype._apply = function(t) {
...
var ph = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.lc = n, i.fc = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        return new Hu(t.firestore, t.converter, Be(t._query, this.lc, this.fc));
    }, n;
}(uh);
 ...
 * @returns The created {@link Query}.
 */ function vh(t) {
    return ju("limit", t), new ph("limit", t, "F" /* First */)
    /**
...
function yh(t) {
    return ju("limitToLast", t), new ph("limitToLast", t, "L" /* Last */);
}

var mh = /** @class */ function(e) {
    function n(t, n, r) {
        var i = this;
        return (i = e.call(this) || this).type = t, i.dc = n, i._c = r, i;
    }
    return t(n, e), n.prototype._apply = function(t) {
        var e = Th(t, this.type, this.dc, this._c);
        return new Hu(t.firestore, t.converter, function(t, e) {
...
function gh() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new mh("startAt", t, 
    /*inclusive=*/ !0);
}

function wh() {
    for (var t = [], e = 0; e < arguments.length; e++) t[e] = arguments[e];
    return new mh("startAfter", t, 
    /*inclusive=*/ !1);
}
...
/** Helper function to create a bound from a document or fields */ function Th(t, e, n, r) {
    if (n[0] = I(n[0]), n[0] instanceof $c) return function(t, e, n, r, i) {
        ...
        // results.
        for (var o = [], s = 0, a = Ue(t); s < a.length; s++) {
            var u = a[s];
            if (u.field.isKeyField()) o.push(Qt(e, r.key)); else {
                var c = r.data.field(u.field);
                if (At(c)) throw new Y(H.INVALID_ARGUMENT, 'Invalid query. You are trying to start or end a query using a document for which the field "' + u.field + '" is an uncommitted server timestamp. (Since the value of this field is unknown, you cannot start/end a query with it.)');
                if (null === c) {
    ...
    return function(t, e, n, r, i, o) {
        ...
        for (var a = [], u = 0; u < i.length; u++) {
            ...
            if (s[u].field.isKeyField()) {
                ...
                if (!Pe(t) && -1 !== c.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection and ordering by documentId(), the value passed to " + r + "() must be a plain document ID, but '" + c + "' contains a slash.");
                var h = t.path.child(gt.fromString(c));
                if (!Ot.isDocumentKey(h)) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group and ordering by documentId(), the value passed to " + r + "() must result in a valid document path, but '" + h + "' is not because it contains an odd number of segments.");
                var l = new Ot(h);
                a.push(Qt(e, l));
            } else {
                var f = Kc(n, r, c);
...
function Sh(t, e, n) {
    if ("string" == typeof (n = I(n))) {
        ...
        if (!Pe(e) && -1 !== n.indexOf("/")) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection by documentId(), you must provide a plain document ID, but '" + n + "' contains a '/' character.");
        var r = e.path.child(gt.fromString(n));
        if (!Ot.isDocumentKey(r)) throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying a collection group by documentId(), the value provided must result in a valid document path, but '" + r + "' is not because it has an odd number of segments (" + r.length + ").");
        return Qt(t, new Ot(r));
    }
    if (n instanceof Wu) return Qt(t, n._key);
    throw new Y(H.INVALID_ARGUMENT, "Invalid query. When querying with documentId(), you must provide a valid string or a DocumentReference, but it was: " + Bu(n) + ".");
}
 ...
 */ var Dh = /** @class */ function() {
    ...
    return t.prototype.convertValue = function(t, e) {
        ...
        return new _c(Nt(t.latitude), Nt(t.longitude));
        ...
        z(Vr(n));
        var r = new Mt(n.get(1), n.get(3)), i = new Ot(n.popFirst(5));
        return r.isEqual(e) || 
...
var Ch = /** @class */ function(e) {
...
}(Dh), kh = /** @class */ function() {
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._commitHandler = e, this._mutations = [], this._committed = !1, 
        this._dataReader = Mc(t);
    }
    return t.prototype.set = function(t, e, n) {
        this._verifyNotCommitted();
        var r = xh(t, this._firestore), i = Ah(r.converter, e, n), o = Rc(this._dataReader, "WriteBatch.set", r._key, i, null !== r.converter, n);
        return this._mutations.push(o.toMutation(r._key, fn.none())), this;
    }, t.prototype.update = function(t, e, n) {
        for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
        this._verifyNotCommitted();
        var o, s = xh(t, this._firestore);
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Ic ? Bc(this._dataReader, "WriteBatch.update", s._key, e, n, r) : qc(this._dataReader, "WriteBatch.update", s._key, e), 
        this._mutations.push(o.toMutation(s._key, fn.exists(!0))), this;
    }, 
    /**
    ...
    t.prototype.delete = function(t) {
        this._verifyNotCommitted();
        var e = xh(t, this._firestore);
        return this._mutations = this._mutations.concat(new Dn(e._key, fn.none())), this;
    }, 
    /**
 ...
 */ function Mh(t) {
    t = Ku(t, Wu);
    var e = Ku(t.firestore, oc);
    return Vu(uc(e), t._key).then((function(n) {
        return Qh(e, t, n);
    }));
}
 ...
 */ function Vh(t) {
    t = Ku(t, Wu);
    var e = Ku(t.firestore, oc), i = uc(e), o = new Rh(e);
    return function(t, e) {
        var i = this, o = new X;
        return t.asyncQueue.enqueueAndForget((function() {
            return n(i, void 0, void 0, (function() {
                            ...
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      ...
                                      case 2:
                                        return o = r.sent(), s = va(o, "Failed to get document '" + e + " from cache"), 
        ...
        return new nh(e, o, t._key, n, new eh(null !== n && n.hasLocalMutations, 
 ...
 */ function Oh(t) {
    t = Ku(t, Hu);
    var e = Ku(t.firestore, oc), n = uc(e), r = new Rh(e);
    return ah(t._query), Lu(n, t._query).then((function(n) {
        return new ih(e, r, t, n);
    }))
    /**
                        ...
                        return i = function(t, e, i) {
                            return n(this, void 0, void 0, (function() {
                                ...
                                return r(this, (function(r) {
                                    switch (r.label) {
                                      case 0:
                                        return r.trys.push([ 0, 2, , 3 ]), [ 4 /*yield*/ , ts(t, e, 
                                        /* usePreviousResults= */ !0) ];

                                      case 1:
                                        return n = r.sent(), o = new Ra(e, n.hi), s = o.La(n.documents), a = o.applyChanges(s, 
                                        /* updateLimboDocuments= */ !1), i.resolve(a.snapshot), [ 3 /*break*/ , 3 ];

                                      case 2:
                                        return u = r.sent(), c = va(u, "Failed to execute query '" + e + " against cache"), 
...
function Uh(t, e, n) {
    t = Ku(t, Wu);
    var r = Ku(t.firestore, oc), i = Ah(t.converter, e, n);
    return zh(r, [ Rc(Mc(r), "setDoc", t._key, i, null !== t.converter, n).toMutation(t._key, fn.none()) ]);
}

function qh(t, e, n) {
    for (var r = [], i = 3; i < arguments.length; i++) r[i - 3] = arguments[i];
    t = Ku(t, Wu);
    var o = Ku(t.firestore, oc), s = Mc(o);
    return zh(o, [ ("string" == typeof (
    // For Compat types, we have to "extract" the underlying types before
    // performing validation.
    e = I(e)) || e instanceof Ic ? Bc(s, "updateDoc", t._key, e, n, r) : qc(s, "updateDoc", t._key, e)).toMutation(t._key, fn.exists(!0)) ]);
}
 ...
 */ function Bh(t) {
    return zh(Ku(t.firestore, oc), [ new Dn(t._key, fn.none()) ]);
}
 ...
 */ function Kh(t, e) {
    var n = Ku(t.firestore, oc), r = $u(t), i = Ah(t.converter, e);
    return zh(n, [ Rc(Mc(t.firestore), "addDoc", r._key, i, null !== t.converter, {}).toMutation(r._key, fn.exists(!1)) ]).then((function() {
        return r;
    }));
}
...
function jh(t) {
    ...
    "object" != typeof s[c] || nc(s[c]) || (u = s[c], c++);
    var h, l, f, d = {
    ...
    if (t instanceof Wu) l = Ku(t.firestore, oc), f = Re(t._key.path), h = {
        next: function(e) {
            s[c] && s[c](Qh(l, t, e));
        },
        error: s[c + 1],
        ...
        var v = Ku(t, Hu);
        l = Ku(v.firestore, oc), f = v._query;
        var y = new Rh(l);
        h = {
            next: function(t) {
                s[c] && s[c](new ih(l, y, v, t));
            },
            error: s[c + 1],
            complete: s[c + 2]
        }, ah(t._query);
    ...
    return function(t, e, i, o) {
        var s = this, a = new bu(o), u = new Na(e, a, i);
        return t.asyncQueue.enqueueAndForget((function() {
            return n(s, void 0, void 0, (function() {
                var e;
                return r(this, (function(n) {
            ...
            a.mu(), t.asyncQueue.enqueueAndForget((function() {
                return n(s, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
                          case 0:
                            return e = Ea, [ 4 /*yield*/ , Ru(t) ];
...
function Gh(t, e) {
    return function(t, e) {
        ...
        return t.asyncQueue.enqueueAndForget((function() {
            ...
            o.mu(), t.asyncQueue.enqueueAndForget((function() {
                return n(i, void 0, void 0, (function() {
                    var e;
                    return r(this, (function(n) {
                        switch (n.label) {
 ...
 */ function Qh(t, e, n) {
    var r = n.docs.get(e._key), i = new Rh(t);
    return new nh(t, i, e._key, r, new eh(n.hasPendingWrites, n.fromCache), e.converter);
}
 ...
 */ var Wh, Hh = /** @class */ function(e) {
     ...
     */    return t(n, e), n.prototype.get = function(t) {
        var n = this, r = xh(t, this._firestore), i = new Rh(this._firestore);
        return e.prototype.get.call(this, t).then((function(t) {
            return new nh(n._firestore, i, r._key, t._document, new eh(
            /* hasPendingWrites= */ !1, 
    ...
    /** @hideconstructor */
    function t(t, e) {
        this._firestore = t, this._transaction = e, this._dataReader = Mc(t)
        /**
     * Reads the document referenced by the provided {@link DocumentReference}.
     *
     * @param documentRef - A reference to the document to be read.
    ...
    return t.prototype.get = function(t) {
        var e = this, n = xh(t, this._firestore), r = new Ch(this._firestore);
        return this._transaction.lookup([ n._key ]).then((function(t) {
            if (!t || 1 !== t.length) return G();
            var i = t[0];
            if (i.isFoundDocument()) return new $c(e._firestore, r, i.key, i, n.converter);
            if (i.isNoDocument()) return new $c(e._firestore, r, n._key, null, n.converter);
            throw G();
        }));
    }, t.prototype.set = function(t, e, n) {
        var r = xh(t, this._firestore), i = Ah(r.converter, e, n), o = Rc(this._dataReader, "Transaction.set", r._key, i, null !== r.converter, n);
        ...
        // For Compat types, we have to "extract" the underlying types before
        // performing validation.
                return o = "string" == typeof (e = I(e)) || e instanceof Ic ? Bc(this._dataReader, "Transaction.update", s._key, e, n, r) : qc(this._dataReader, "Transaction.update", s._key, e), 
            ...
            return n(i, void 0, void 0, (function() {
                ...
                return r(this, (function(r) {
                    switch (r.label) {
                      ...
                      case 1:
                        return n = r.sent(), new Tu(t.asyncQueue, n, e, o).run(), [ 2 /*return*/ ];
                    }
                }));
            }));
        })), o.promise;
    }(uc(t = Ku(t, oc)), (function(n) {
        return e(new Hh(t, n));
    }));
}
 ...
 * writes.
 */ function el(t) {
    return uc(t = Ku(t, oc)), new kh(t, (function(e) {
        return zh(t, e);
    }))
    /**
 * @license
...
function nl(t, e) {
    ...
    // persistence since `enableIndexeddbPersistence()` can fail on the Web.
        ...
        var s = o[i], a = rl(s, "collectionGroup"), u = [];
        if (Array.isArray(s.fields)) for (var c = 0, h = s.fields; c < h.length; c++) {
            var l = h[c], f = Yc("setIndexConfiguration", rl(l, "fieldPath"));
            "CONTAINS" === l.arrayConfig ? u.push(new ue(f, 2 /* CONTAINS */)) : "ASCENDING" === l.order ? u.push(new ue(f, 0 /* ASCENDING */)) : "DESCENDING" === l.order && u.push(new ue(f, 1 /* DESCENDING */));
        }
        r.push(new oe(oe.UNKNOWN_ID, a, u, ce.empty()));
    }
 ...
 */ void 0 === Wh && (Wh = !0), O = i, o(new c("firestore", (function(t, e) {
    var n = e.options, r = t.getProvider("app").getImmediate(), i = new oc(r, new tt(t.getProvider("auth-internal")), new it(t.getProvider("app-check-internal")));
